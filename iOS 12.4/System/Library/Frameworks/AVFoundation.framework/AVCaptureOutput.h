...
+(id)availableVideoCodecTypesForSourceDevice:(id)arg1 sourceFormat:(id)arg2 outputDimensions:(SCD_Struct_AV39)arg3 fileType:(id)arg4 videoCodecTypesWhiteList:(id)arg5 ;
