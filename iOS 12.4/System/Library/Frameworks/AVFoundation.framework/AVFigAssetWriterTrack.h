...
@interface AVFigAssetWriterTrack : NSObject {
	...
	SCD_Struct_AV5 _sampleBufferCoalescingInterval;
...
@property (assign,nonatomic) SCD_Struct_AV5 sampleBufferCoalescingInterval;              //@synthesize sampleBufferCoalescingInterval=_sampleBufferCoalescingInterval - In the implementation block
...
-(void)setSampleBufferCoalescingInterval:(SCD_Struct_AV5)arg1 ;
...
-(void)setPreferredChunkDuration:(SCD_Struct_AV5)arg1 ;
...
-(BOOL)addPixelBuffer:(CVBufferRef)arg1 atPresentationTime:(SCD_Struct_AV5)arg2 error:(id*)arg3 ;
...
-(SCD_Struct_AV5)sampleBufferCoalescingInterval;
-(NSString *)mediaType;
