...
-(BOOL)insertTimeRanges:(id)arg1 ofTracks:(id)arg2 atTime:(SCD_Struct_AV5)arg3 error:(id*)arg4 ;
...
-(BOOL)insertTimeRange:(SCD_Struct_AV6)arg1 ofTrack:(id)arg2 atTime:(SCD_Struct_AV5)arg3 error:(id*)arg4 ;
