...
@protocol OS_dispatch_queue, UIViewControllerPreviewing, EKDayViewControllerDelegate, EKDayViewControllerDataSource;
@class UIView, UIScrollView, EKDayView, EKDayOccurrenceView, EKDayViewWithGutters, NSDateComponents, CalendarOccurrencesCollection, EKEventGestureController, ScrollSpringFactory, NSObject, NSCalendar, EKEventEditViewController, NSTimer, NSString;
...
-(void)reloadDataBetweenStart:(id)arg1 end:(id)arg2 completionForCurrentDayReload:(/*^block*/id)arg3 ;
