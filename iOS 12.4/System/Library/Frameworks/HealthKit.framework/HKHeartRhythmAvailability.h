...
@class NSNumber, HKHealthStore, HKKeyValueDomain, NSUserDefaults, NPSManager, HKObserverSet, HKActiveWatchFeatureAvailabilityDataSource, HKMobileCountryCodeManager, NSDate;
