...
@class HKWorkoutBuilderConfiguration, NSDate, NSDictionary, NSArray, HKStateMachine, HKWorkoutConfiguration, NSMutableDictionary, NSObject, HKTaskServerProxyProvider, HKHealthStore, NSUUID, HKDevice, NSString;
