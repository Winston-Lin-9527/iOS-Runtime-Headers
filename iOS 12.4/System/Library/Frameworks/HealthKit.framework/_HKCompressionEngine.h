...
@property (assign,nonatomic) SCD_Struct_HK20* stream;                                     //@synthesize stream=_stream - In the implementation block
...
-(void)setStream:(SCD_Struct_HK20*)arg1 ;
-(SCD_Struct_HK20*)stream;
-(void)dealloc;
