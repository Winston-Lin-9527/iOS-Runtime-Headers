...
@protocol MKMapViewDelegateMKMapViewDelegatePrivate, OS_dispatch_group;
@class MKMapViewInternal, UIView, MKAnnotationManager, MKAnnotationContainerView, MKAttributionLabel, UIImageView, NSTimer, MKDebugLocationConsole, _MKEnvironmentLabel, UILongPressGestureRecognizer, UITapGestureRecognizer, UIGestureRecognizer, MKMapGestureController, MKOverlayContainerView, MKBasicMapView, VKMapView, VKLabelMarker, MKScaleView, MKCompassView, MKUserLocation, VKRouteContext, VKNavContext, MKMapCamera, UITextView, UIPanGestureRecognizer, MKRotationFilter, UILayoutGuide, NSLayoutConstraint, NSObject, _MKCustomFeatureStore, MKMapViewLabelMarkerState, CLLocation, MKAnnotationView, NSArray, NSString, NSDictionary, GEOResourceManifestConfiguration, GEOMapRegion, UIPinchGestureRecognizer, UIRotationGestureRecognizer, VKVenueFeatureMarker, VKVenueBuildingFeatureMarker;
