...
@property (assign,getter=isContentItemIDPredetermined,nonatomic) BOOL contentItemIDPredetermined;                                        //@synthesize contentItemIDPredetermined=_contentItemIDPredetermined - In the implementation block
@property (nonatomic,retain) NSDictionary * indexPathToContentItemIDMap;                                                                 //@synthesize indexPathToContentItemIDMap=_indexPathToContentItemIDMap - In the implementation block
...
-(id)_buildIndexPathToContentItemIDMapFromItemQueryResults:(shared_ptr<mlcore::EntityQueryResult>*)arg1 ;
-(BOOL)_usesSections;
...
-(NSDictionary *)indexPathToContentItemIDMap;
-(void)setIndexPathToContentItemIDMap:(NSDictionary *)arg1 ;
