...
@property (nonatomic,readonly) SCD_Struct_MD22 voxelIndexExtent;              //@synthesize extent=_extent - In the implementation block
@property (nonatomic,readonly) SCD_Struct_MD22 boundingBox; 
...
-(SCD_Struct_MD22)voxelIndexExtent;
...
-(id)initWithData:(id)arg1 boundingBox:(SCD_Struct_MD22)arg2 voxelExtent:(float)arg3 ;
-(BOOL)voxelExistsAtIndex:(BOOL)arg1 allowAnyX:(BOOL)arg2 allowAnyY:(BOOL)arg3 allowAnyZ:(BOOL)arg4 ;
-(id)voxelsWithinExtent:(SCD_Struct_MD22)arg1 ;
-(id)voxelIndices;
...
-(SCD_Struct_MD22)voxelBoundingBoxAtIndex:;
