...
#import <libobjc.A.dylib/PHImportSidecarAsset.h>
...
@property (nonatomic,readonly) unsigned long long sidecarType;                           //@synthesize sidecarType=_sidecarType - In the implementation block
@property (nonatomic,readonly) BOOL isValid; 
