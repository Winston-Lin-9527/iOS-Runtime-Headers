...
@property (nonatomic,readonly) UIButton * useCustomPasswordButton;                       //@synthesize useCustomPasswordButton=_useCustomPasswordButton - In the implementation block
...
-(UIButton *)useCustomPasswordButton;
