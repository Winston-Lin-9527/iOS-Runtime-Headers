...
@class _SFBrowserView, SFReaderViewController, WKBackForwardListItem, _SFNavigationBar, _SFBrowserToolbar, _SFMailContentProvider, _WKUserInitiatedAction, _SFBarManager, _SFDynamicBarAnimator, _SFNavigationBarItem, _SFURLSpoofingMitigator, WBSFluidProgressState, WBSFluidProgressController, _SFFluidProgressView, UITapGestureRecognizer, _SFPageLoadErrorController, _SFCalendarEventDetector, _SFDownload, NSString, _SFSafariSharingExtensionController, WKPreferences, _SFTelephonyNavigationMitigationPolicy, _SFPrintController, _SFSecIdentityPreferencesController, WBSAutomaticReaderActivationManager, _SFNavigationUtilitiesManager, SFReaderEnabledWebViewController, _SFAppleConnectExtensionPageController, NSURL, _SFReloadOptionsController, _SFFindOnPageView, NSArray, _WKActivatedElementInfo, UIColor, SFSafariViewControllerConfiguration, SFBrowserPersonaAnalyticsHelper, WKWebView;
