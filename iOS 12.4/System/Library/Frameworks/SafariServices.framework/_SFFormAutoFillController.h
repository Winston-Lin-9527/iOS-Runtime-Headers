...
@class WKWebView, _WKRemoteObjectInterface, SFFormAutocompleteState, NSTimer, WBSFormMetadata, SFFormAutoFillFrameHandle, NSMutableIndexSet, NSMutableSet, NSString, NSArray, _SFFormAutoFillInputSession, _SFAutoFillInputView, NSDictionary, WBSCreditCardData, NSSet, _SFAuthenticationContext, WBSOneTimeCodeMonitor;
