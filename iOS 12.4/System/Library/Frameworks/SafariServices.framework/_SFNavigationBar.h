...
@class UIButton, UIView, _SFNavigationBarLabelsContainer, UILabel, UIImageView, _SFToolbar, SFCrossfadingImageView, NSArray, _SFNavigationBarURLButton, _SFFluidProgressView, _SFNavigationBarBackdrop, NSAttributedString, SFNavigationBarReaderButton, _SFDimmingButton, UILongPressGestureRecognizer, NSTimer, SFDismissButton, _SFNavigationBarItem, _UIBackdropViewSettings, UITextField, NSString, UIColor;
