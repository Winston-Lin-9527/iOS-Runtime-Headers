...
@interface SCNAuthoringEnvironment : NSObject {
	...
	SCD_Struct_SC135* _logsInfo;
	SCD_Struct_SC135* _boldLogsInfo;
	SCD_Struct_SC135* _dynamicLinesInfo;
	SCD_Struct_SC135* _dynamicLinesNoDepthTestInfo;
	SCD_Struct_SC135* _dynamicTrianglesInfo;
	SCD_Struct_SC135* _overlayDynamicLinesInfo;
	SCD_Struct_SC135* _overlayDynamicTriangleInfo;
	SCD_Struct_SC135* _textInfo;
	SCD_Struct_SC135* _lightProbesInfo;
	SCD_Struct_SC137* _normalTextInfo;
	SCD_Struct_SC137* _boldTextInfo;
	...
	SCD_Struct_SC139* _statisticsInfo;
	float _drawScale;
	id _delegate;
