...
@interface SCNCameraController : NSObject {
	...
	SCD_Struct_SC16 _inputLocation;
	SCD_Struct_SC16 _arcball;
...
-(SCD_Struct_SC16)unrolledWorldOrientation:(out float*)arg1 ;
...
-(SCD_Struct_SC16)_orientationForMode;
-(SCD_Struct_SC16)_convertRotationFromWorldToPointOfView:(SCD_Struct_SC16)arg1 ;
...
-(SCD_Struct_SC14)lookAtWith:target:;
