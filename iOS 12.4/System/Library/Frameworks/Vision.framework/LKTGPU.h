...
-(int)_doSolverWithCommandBuffer:(id)arg1 scale:(int)arg2 scale_factor:(id)arg3 in_uv_tex:(id)arg4 out_uv_tex:(id)arg5 ;
...
-(int)estimateFlowFromReference:(CVBufferRef)arg1 target:(CVBufferRef)arg2 ;
-(int)estimateFlowStream:(CVBufferRef)arg1 ;
