...
@class UITextInteractionAssistant, RTIInputSystemSourceSession, WKWebView, NSString, UIWebFormAccessory, UITextInputAssistantItem, NSArray, UITextInputPasswordRules, UITextRange, NSDictionary, UITextPosition, UIView, NSIndexSet, UIColor, UIImage, UIInputContextHistory, WKFormInputControl, WKBrowsingContextController;
...
-(void)_elementDidFocus:(const FocusedElementInformation*)arg1 userIsInteracting:(BOOL)arg2 blurPreviousNode:(BOOL)arg3 changingActivityState:(BOOL)arg4 userObject:(id)arg5 ;
...
-(void)_showShareSheet:(const ShareDataWithParsedURL*)arg1 completionHandler:(CompletionHandler<void (bool)>*)arg2 ;
