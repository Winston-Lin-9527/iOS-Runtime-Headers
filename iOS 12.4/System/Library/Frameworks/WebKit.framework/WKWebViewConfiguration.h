...
@class WKWebView, NSString, _WKVisitedLinkStore, _WKApplicationManifest, _WKWebsiteDataStore, NSArray, WKWebViewContentProviderRegistry, WKProcessPool, WKPreferences, WKUserContentController, WKWebsiteDataStore;
