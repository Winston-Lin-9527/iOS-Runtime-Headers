...
@class NSString, NSURL, ADSInternalSize, ADContext, ADAdImpressionPublicAttributes, ADAdActionPublicAttributes, ADPrivacyDetailsAttributes, ADMediaAnalyticsEventInfo, ADMRAIDAction, ADCreativeController, ADWebViewActionViewController, UIViewController, NSArray, NewsTransparencyViewController, ADAdSpaceConfiguration;
...
@property (nonatomic,readonly) ADPrivacyDetailsAttributes * currentPrivacyDetailsAttributes;                              //@synthesize currentPrivacyDetailsAttributes=_currentPrivacyDetailsAttributes - In the implementation block
...
-(ADPrivacyDetailsAttributes *)currentPrivacyDetailsAttributes;
