...
@protocol NSObject;
@class NSString, NSMutableArray, SafariSearchController, UIBarButtonItem, _SFPasswordIconController, NSCountedSet, _SFSiteMetadataManager, SFSharablePassword, _UIContentUnavailableView, NSDictionary, WBSAutoFillQuirksManager, WBSSavedPasswordAuditor;

@interface SafariSavedPasswordsController : SafariAutoFillListController <PSListControllerURLHandler, SafariSearchControllerDelegate, UISearchBarDelegate, UISearchResultsUpdating, _SFPasswordIconControllerDelegate, _SFSettingsAuthenticationRequiring> {
