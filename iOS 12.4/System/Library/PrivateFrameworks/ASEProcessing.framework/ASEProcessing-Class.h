...
-(long long)processFrameWithInput:(SCD_Struct_AS10*)arg1 Output:(SCD_Struct_AS9*)arg2 ;
-(void)setDestinationHeight:(unsigned)arg1 ;
-(void)setDestinationWidth:(unsigned)arg1 ;
-(unsigned)destinationWidth;
-(id)initWithConfig:(const SCD_Struct_AS11*)arg1 ;
-(void)processPixelWithInput:(const SCD_Struct_AS10*)arg1 Output:(SCD_Struct_AS9*)arg2 ;
-(void)processPixelWithInput_V0:(const SCD_Struct_AS10*)arg1 Output:(SCD_Struct_AS9*)arg2 ;
-(void)processPixelWithInput_V1:(const SCD_Struct_AS10*)arg1 Output:(SCD_Struct_AS9*)arg2 ;
-(void)processPixelWithPixelControl_V0:(SCD_Struct_AS12*)arg1 ;
-(void)processPixelWithMeasurement_V0:(const SCD_Struct_AS10*)arg1 pixelControl:(SCD_Struct_AS12*)arg2 ;
-(void)digitalZoomSelectControl_V0:(SCD_Struct_AS12*)arg1 ;
-(void)printAseMeasurementOutput:(const SCD_Struct_AS10*)arg1 ;
-(void)processPixelWithPixelControl_V1:(SCD_Struct_AS7*)arg1 ;
-(void)processPixelWithMeasurement_V1:(const SCD_Struct_AS10*)arg1 pixelControl:(SCD_Struct_AS7*)arg2 ;
-(void)digitalZoomSelectControl_V1:(SCD_Struct_AS7*)arg1 ;
-(long long)processFrameWithInput:(SCD_Struct_AS10*)arg1 callback:(/*^block*/id)arg2 ;
