...
@interface VCAudioTransmitter : NSObject <VCAudioIOSink, VCConnectionChangedHandler> {
	...
	SCD_Struct_VC102 _currentChannelMetrics;
	SCD_Struct_VC136 _idsChannelDataFormat;
...
@property (assign,nonatomic) SCD_Struct_VC102 currentChannelMetrics;                          //@synthesize currentChannelMetrics=_currentChannelMetrics - In the implementation block
...
-(SCD_Struct_VC102)currentChannelMetrics;
...
-(void)setCurrentChannelMetrics:(SCD_Struct_VC102)arg1 ;
