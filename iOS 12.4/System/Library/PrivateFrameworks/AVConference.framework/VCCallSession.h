...
-(void)sendWRMStatusUpdate:(const SCD_Struct_VC87*)arg1 ;
...
-(BOOL)initializeVideoTransmitter:(id*)arg1 encodeRule:(id)arg2 captureRuleWifi:(id)arg3 captureRuleCellular:(id)arg4 unpausing:(BOOL)arg5 reportingAgent:(opaqueRTCReportingRef)arg6 ;
...
-(void)callAlarmsWithRTPTimeStamp:(SCD_Struct_AV56*)arg1 ;
-(void)processResolutionChangeToVideoRule:(id)arg1 captureRule:(id)arg2 featuresListString:(id)arg3 ;
-(BOOL)onCaptureFrame:(opaqueCMSampleBufferRef)arg1 audioTS:(unsigned)arg2 audioHT:(double)arg3 videoHT:(SCD_Struct_AV56)arg4 droppedFrames:(int)arg5 cameraBits:(unsigned char)arg6 ;
-(void)processBlackFrame:(opaqueCMSampleBufferRef)arg1 ;
-(void)updateVideoQualityNotification:(double)arg1 ;
-(void)onPlayVideo:(CVBufferRef)arg1 frameTime:(SCD_Struct_AV56)arg2 cameraStatusBits:(unsigned char)arg3 ;
