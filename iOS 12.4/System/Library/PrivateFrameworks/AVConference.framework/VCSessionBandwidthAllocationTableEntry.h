...
-(id)initWithClient:(id)arg1 type:(unsigned char)arg2 networkBitrate:(unsigned)arg3 qualityIndex:(unsigned)arg4 streamID:(unsigned)arg5 ;
...
-(id)initWithClient:(id)arg1 type:(unsigned char)arg2 networkBitrate:(unsigned)arg3 qualityIndex:(unsigned)arg4 streamID:(unsigned)arg5 hasRepairStreamID:(BOOL)arg6 repairStreamID:(unsigned)arg7 repairMaxNetworkBitrate:(unsigned)arg8 enabled:(BOOL)arg9 ;
