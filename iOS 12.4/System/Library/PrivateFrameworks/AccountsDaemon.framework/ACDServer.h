...
@class NSXPCListener, NSMutableArray, NSMutableDictionary, NSObject, ACDAuthenticationPluginManager, ACDAccessPluginManager, ACDDataclassOwnersManager, ACDAuthenticationDialogManager, ACRemoteDeviceProxy, ACDDatabaseBackupActivity, NSString;
