...
-(SCD_Struct_AC8)currentStateForGoalType:(long long)arg1 ;
-(void)setNewState:(SCD_Struct_AC8)arg1 forGoalType:(long long)arg2 ;
...
-(SCD_Struct_AC8)currentMoveState;
-(SCD_Struct_AC8)currentExerciseState;
-(SCD_Struct_AC8)currentStandState;
-(void)setNewMoveState:(SCD_Struct_AC8)arg1 ;
-(void)setNewExerciseState:(SCD_Struct_AC8)arg1 ;
-(void)setNewStandState:(SCD_Struct_AC8)arg1 ;
