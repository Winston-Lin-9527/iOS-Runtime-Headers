...
@interface ACHEarnedInstanceAwardingEngine : NSObject <HDDatabaseProtectedDataObserver> {
	...
	SCD_Struct_AC11 _historicalEvaluationPolicy;
...
-(id)initWithProfile:(id)arg1 dataStore:(id)arg2 earnedInstanceStore:(id)arg3 historicalEvaluationPolicy:(SCD_Struct_AC11)arg4 ;
