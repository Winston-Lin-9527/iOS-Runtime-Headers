...
@class AAUIBadge, GLKTextureInfo, UIImage, NSAttributedString, NSDictionary, UIPanGestureRecognizer, UITapGestureRecognizer, UILongPressGestureRecognizer, AAUIBadgeModelConfiguration, NSString;
