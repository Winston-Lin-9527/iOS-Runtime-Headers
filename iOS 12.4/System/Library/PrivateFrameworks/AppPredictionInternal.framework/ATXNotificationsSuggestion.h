...
@class NSObject, _ATXAppLaunchCategoricalHistogram, _ATXAppLaunchHistogram, ATXNotificationsLogger, _ATXAggregateLogger, _ATXDataStore, ATXNotificationsPriors, NSMutableSet, ATXNotificationsSuggestionLR, NSMutableDictionary, ATXNotificationsRecorderPermanentStore;
