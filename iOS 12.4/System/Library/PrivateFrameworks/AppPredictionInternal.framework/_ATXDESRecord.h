...
@interface _ATXDESRecord : NSObject <NSSecureCoding> {
	...
	SCD_Struct_AT40* _predictionItems;
...
@property (nonatomic,readonly) SCD_Struct_AT40* predictionItems;                //@synthesize predictionItems=_predictionItems - In the implementation block
...
-(SCD_Struct_AT40*)predictionItems;
