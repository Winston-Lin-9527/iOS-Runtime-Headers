...
+(double)kendallTauFirstItems:(SCD_Struct_AT40*)arg1 secondItems:(SCD_Struct_AT40*)arg2 count:(unsigned long long)arg3 ;
+(unsigned long long)rankOfScore:(double)arg1 inputItems:(SCD_Struct_AT40*)arg2 count:(unsigned long long)arg3 ;
+(id)inputScoresFromItem:(SCD_Struct_AT40*)arg1 ;
