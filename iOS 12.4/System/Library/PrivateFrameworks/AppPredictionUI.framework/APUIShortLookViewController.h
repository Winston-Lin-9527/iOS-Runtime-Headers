...
@class PLPreviewInteractionManager, UIView, SFSearchResult, APUILongLookViewController, APUITVIntentHandler, NSUserDefaults, INIntent, NSUserActivity, NSString, APUIIntentHandlingViewController, ATXAction, INInteraction, CRKCardPresentation, UIViewController;
