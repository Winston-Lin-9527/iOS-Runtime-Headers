...
@protocol OS_dispatch_queue, CVAVideoPipelinePropertiesSPI;
...
@interface CVAPortraitVideoPipeline_Impl : NSObject <CVADisparityPostprocessingVideoPipeline, CVAMattingVideoPipeline, CVAPortraitVideoPipeline> {
	...
	RelightingTransitionData _relightingTransitionData;
...
+(void)drawCanonicalDisparity:(CVBufferRef)arg1 onColor:(CVBufferRef)arg2 focusMachineState:(int)arg3 offsetX:(unsigned long long)arg4 offsetY:(unsigned long long)arg5 ;
...
-(BOOL)validateSegmentationPixelBuffer:(CVBufferRef)arg1 matchFormat:(unsigned)arg2 error:(id*)arg3 ;
...
-(void)internal_relightWithRequest:(id)arg1 intermediateSourceBuffer:(CVBufferRef)arg2 faceKitProcessOutput:(id)arg3 mattingResult:(id)arg4 singleCubeData:(id)arg5 transitionData:(const RelightingTransitionData*)arg6 portraitCompletionHandler:(/*^block*/id)arg7 timestamp:(long long)arg8 status:(int*)arg9 ;
