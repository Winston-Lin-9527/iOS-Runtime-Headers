...
@interface CVAVideoPipelineProperties_Impl : NSObject <CVAVideoPipelinePropertiesSPI> {
	...
	unsigned _inputSegmentationPixelBufferPixelFormat;
...
@property (readonly) unsigned inputSegmentationPixelBufferPixelFormat;                         //@synthesize inputSegmentationPixelBufferPixelFormat=_inputSegmentationPixelBufferPixelFormat - In the implementation block
...
@property (assign) float lowResolutionMatteDownsamplingScale;                                  //@synthesize lowResolutionMatteDownsamplingScale=_lowResolutionMatteDownsamplingScale - In the implementation block
...
-(unsigned)inputSegmentationPixelBufferPixelFormat;
