...
-(id)initWithAddress:(id)arg1 deviceUID:(id)arg2 vendorID:(unsigned)arg3 productID:(unsigned)arg4 isAdvancedAppleAudioDevice:(BOOL)arg5 supportsInEarDetection:(BOOL)arg6 supportsVoiceTrigger:(BOOL)arg7 ;
-(unsigned)vendorID;
-(NSString *)address;
-(unsigned)productID;
