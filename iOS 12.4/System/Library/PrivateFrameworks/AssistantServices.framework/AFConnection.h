...
@class NSXPCConnection, NSObject, NSString, NSArray, AFClockAlarmSnapshot, AFClockTimerSnapshot, NSUUID, AFOneArgumentSafetyBlock, NSMutableDictionary, AFAudioPowerUpdater, AFClientConfiguration, AFInterstitialProvider, NSMutableArray, NSError;
