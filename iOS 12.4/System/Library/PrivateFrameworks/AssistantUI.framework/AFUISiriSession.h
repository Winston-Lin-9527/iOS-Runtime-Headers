...
@class NSObject, AFUIStateMachine, AFUISpeechSynthesis, NSMutableSet, AFConnection, AFSettingsConnection, AFConnectionUserInteractionAssertion, AFUISiriSessionInfo, AFAnalyticsTurnBasedInstrumentationContext, NSString;
