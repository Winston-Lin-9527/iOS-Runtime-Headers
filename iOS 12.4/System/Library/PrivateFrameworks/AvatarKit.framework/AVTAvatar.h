...
@class AVTMemoji, SCNNode, AVTPhysicsController, NSMutableArray, AVTPupilReflectionCorrectionDescriptor, AVTEyeSkinningDescriptor, CAAnimation, SCNAnimationPlayer, NSString;
