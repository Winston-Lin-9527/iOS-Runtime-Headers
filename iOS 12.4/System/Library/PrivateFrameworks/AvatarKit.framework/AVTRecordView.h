...
@class NSObject, NSMutableData, CAAnimationGroup, AVCaptureMovieFileOutput, AVPlayer, AVAssetWriterInput, AVAssetWriter, NSLock, NSMutableArray, CALayer, NSString;
