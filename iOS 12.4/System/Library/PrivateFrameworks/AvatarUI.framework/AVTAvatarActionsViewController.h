...
@class UIStackView, AVTImageTransitioningContainerView, AVTAvatarActionButton, AVTAvatarActionsModel, AVTViewSessionProvider, AVTViewSession, UIImageView, UITapGestureRecognizer, AVTUIEnvironment, NSString;
