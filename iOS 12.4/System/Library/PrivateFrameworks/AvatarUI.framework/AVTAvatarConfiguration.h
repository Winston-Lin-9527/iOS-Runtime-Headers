...
+(id)configurationPresetWithPreset:(id)arg1 settingKind:(SCD_Struct_AV3)arg2 ;
+(id)configurationColorPresetWithColorPreset:(id)arg1 settingKind:(SCD_Struct_AV3)arg2 coreModel:(id)arg3 ;
+(id)keyForSettingKind:(SCD_Struct_AV3)arg1 ;
-(id)presets;
...
-(void)removePresetsForSettingKind:(SCD_Struct_AV3)arg1 storage:(id)arg2 ;
-(id)presetsForStorage:(id)arg1 ;
-(id)presetForSettingKind:(SCD_Struct_AV3)arg1 storage:(id)arg2 ;
...
-(void)removeColorPresetsForSettingKind:(SCD_Struct_AV3)arg1 ;
-(id)colorPresetForSettingKind:(SCD_Struct_AV3)arg1 ;
-(id)configurationPresets;
-(id)configurationPresetForSettingKind:(SCD_Struct_AV3)arg1 ;
-(id)init;
