...
@class BCCloudKitTransactionManager, BCCloudKitDatabaseController, CKContainer, NSObject, BDSCoalescingCallBlock;
...
@property (nonatomic,retain) BDSCoalescingCallBlock * coalescedAttachment;                     //@synthesize coalescedAttachment=_coalescedAttachment - In the implementation block
...
-(BDSCoalescingCallBlock *)coalescedAttachment;
...
-(void)setCoalescedAttachment:(BDSCoalescingCallBlock *)arg1 ;
