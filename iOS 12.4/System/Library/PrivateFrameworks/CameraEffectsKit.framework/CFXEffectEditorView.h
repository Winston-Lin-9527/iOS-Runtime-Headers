...
@class CFXEffect, UIButton, JTTextEffectEditorView, JTEffectsPreviewGenerator, JTImageView, NSObject, NSString, CADisplayLink, CFXFaceReticleView, JTEffectAnimationView, NSMutableArray;

@interface CFXEffectEditorView : UIView <UIGestureRecognizerDelegate, JTTextEffectEditorViewDelegate> {
