...
@interface CFXFaceTrackingRenderer : NSObject <SCNSceneRendererDelegate> {
	...
	CVPixelBufferPoolRef _rotateBufferPoolForLandscapeInputBuffer;
...
@property (assign,nonatomic) CVPixelBufferPoolRef rotateBufferPoolForLandscapeInputBuffer;              //@synthesize rotateBufferPoolForLandscapeInputBuffer=_rotateBufferPoolForLandscapeInputBuffer - In the implementation block
...
-(CVPixelBufferPoolRef)rotateBufferPoolForLandscapeInputBuffer;
-(void)setRotateBufferPoolForLandscapeInputBuffer:(CVPixelBufferPoolRef)arg1 ;
