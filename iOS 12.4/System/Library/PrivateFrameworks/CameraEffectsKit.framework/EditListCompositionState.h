...
@interface EditListCompositionState : NSObject <NSCopying> {
	...
	SCD_Struct_JT16 m_videoCompTimeRange;
	SCD_Struct_JT16 m_audioCompTimeRange;
...
@property (assign,nonatomic) SCD_Struct_JT16 videoCompTimeRange; 
@property (assign,nonatomic) SCD_Struct_JT16 audioCompTimeRange; 
