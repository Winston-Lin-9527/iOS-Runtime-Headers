...
+(void)createStillClipPreviewWithLocalURL:(id)arg1 effectStack:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
+(void)createClipWithLocalURL:(id)arg1 effectStack:(id)arg2 isVideo:(BOOL)arg3 completionHandler:(/*^block*/id)arg4 ;
