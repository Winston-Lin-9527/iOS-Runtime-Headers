...
@class CAMMachineReadableCodeResult, NSArray, CUCaptureController, CAMTimelapseController, CAMBurstIndicatorView, CAMFocusIndicatorView, NSDate, CAMFocusResult, CAMExposureResult, UITapGestureRecognizer, UILongPressGestureRecognizer, UIPanGestureRecognizer, CAMSubjectIndicatorView, CAMStageLightOverlayView, CAMMotionController, CAMPreviewView, NSString;
...
@property (assign,setter=_setDevice:,nonatomic) long long _device;                                                                                     //@synthesize _device=__device - In the implementation block
