...
@class CAMFlashButton, CAMElapsedTimeView, CAMHDRButton, CAMFlipButton, CAMFilterButton, CAMApertureButton, CAMTimerButton, CAMLivePhotoButton, CAMMessagesPhotosButton, PUReviewScreenDoneButton, CAMFramerateIndicatorView, UIView, NSArray, NSSet, CAMExpandableMenuButton;
