...
@property (nonatomic,retain) CAMQRCodeDescriptionOverlayView * qrCodeDescriptionOverlayView;                                                //@synthesize qrCodeDescriptionOverlayView=_qrCodeDescriptionOverlayView - In the implementation block
...
-(void)setQrCodeDescriptionOverlayView:(CAMQRCodeDescriptionOverlayView *)arg1 ;
...
-(CAMQRCodeDescriptionOverlayView *)qrCodeDescriptionOverlayView;
