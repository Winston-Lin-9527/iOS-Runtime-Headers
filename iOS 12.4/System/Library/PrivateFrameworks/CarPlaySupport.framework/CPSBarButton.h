...
@property (nonatomic,retain) UIImage * focusedBackIndicatorImage;                             //@synthesize focusedBackIndicatorImage=_focusedBackIndicatorImage - In the implementation block
...
-(UIImage *)focusedBackIndicatorImage;
-(void)setFocusedBackIndicatorImage:(UIImage *)arg1 ;
