...
-(int)setWhiteBalanceModeLockedWithGains:(SCD_Struct_BW31)arg1 requestID:(int)arg2 ;
-(SCD_Struct_BW31)deviceWhiteBalanceGains;
-(SCD_Struct_BW31)grayWorldDeviceWhiteBalanceGains;
