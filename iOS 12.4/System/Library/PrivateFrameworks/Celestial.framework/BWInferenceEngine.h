...
@class BWInferenceScheduler, BWInferenceDependencyProvider, BWEspressoInferenceAdapter, BWEspressoInferenceContext, BWVisionInferenceAdapter, BWVisionInferenceContext, BWFigVideoCaptureDevice, NSMutableArray, NSMutableDictionary, NSMutableSet, NSDictionary, NSString;
