...
@class BWFigVideoCaptureDevice, BWFigVideoCaptureStream, NSArray, BWNodeOutput, NSDictionary, NSString, BWDeferredMetadataCache, NSMutableDictionary, BWDetectedFacesRingBuffer, NSObject, BWMotionDataPreserver, BWStats;
