...
-(void)setViewports:(const SCD_Struct_CM25*)arg1 count:(unsigned long long)arg2;
...
-(void)setScissorRect:(SCD_Struct_CM26)arg1;
-(void)setScissorRects:(const SCD_Struct_CM26*)arg1 count:(unsigned long long)arg2;
...
-(void)dispatchThreadsPerTile:(SCD_Struct_CM24)arg1;
...
-(void)setViewport:(SCD_Struct_CM25)arg1;
