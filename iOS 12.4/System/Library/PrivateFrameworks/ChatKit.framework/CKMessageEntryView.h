...
@protocol CKMessageEntryViewDelegateUIPreviewInteractionDelegate, UIPreviewInteractionDelegate, CKMessageEntryViewInputDelegate, UITextInputTraits_Private;
@class NSArray, CKConversation, CKMessageEntryContentView, CKMessageEntryWaveformView, CKEntryViewButton, UIView, UILongPressGestureRecognizer, UIPreviewInteraction, CKActionMenuGestureRecognizerButton, CKInlineAudioReplyButtonController, UILabel, _UIBackdropView, CKAudioRecorder, CKComposition, CKActionMenuController, CKMessageEntryRecordedAudioView, CKMessageEntryAudioHintView, UIInputContextHistory, CKBrowserSwitcherFooterView, UIKBVisualEffectView, CAMShutterButton, CKScheduledUpdater, UISwipeGestureRecognizer, NSString;
...
-(void)_animateExpandWithCompletion:(/*^block*/id)arg1 ;
