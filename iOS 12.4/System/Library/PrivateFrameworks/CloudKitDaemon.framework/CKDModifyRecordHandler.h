...
@class CKDModifyRecordsOperation, CKRecord, NSObject, CKDRecordPCSData, CKDSharePCSData, NSString, NSError, NSMutableDictionary, CKDProgressTracker, CKRecordID, CKDPCSManager, CKDPCSCache;
