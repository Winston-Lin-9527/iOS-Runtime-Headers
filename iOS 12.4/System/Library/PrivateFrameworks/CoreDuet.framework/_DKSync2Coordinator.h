...
@class _DKSyncType, NSUUID, _DKThrottledActivity, NSMutableSet, NSMutableArray, _DKDataProtectionStateMonitor, NSString, _DKSync2State, APSConnection, _CDMutablePerfMetric, _DKSyncToggle, _CDPeriodicSchedulerJob, _DKKnowledgeStorage;
