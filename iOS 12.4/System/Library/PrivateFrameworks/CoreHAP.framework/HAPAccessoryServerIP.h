...
@class NSString, NSData, NSDictionary, HAPAccessoryServerBrowserIP, NSArray, NSMutableArray, HAPAccessory, HMFMACAddress, HAPHTTPClient, HAPAuthSession, HAPAccessoryProtocolInfo, NSMutableSet, HMFBlockOperation, NSOperationQueue, HAPWACClient, HMFTimer, HMFNetMonitor;
...
@property (nonatomic,copy) HMFMACAddress * bluetoothAddress;                                                   //@synthesize bluetoothAddress=_bluetoothAddress - In the implementation block
...
-(HMFMACAddress *)bluetoothAddress;
-(void)setBluetoothAddress:(HMFMACAddress *)arg1 ;
