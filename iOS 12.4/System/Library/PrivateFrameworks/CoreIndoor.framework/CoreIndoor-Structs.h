...
typedef struct optional<proto::params::LocalizerParameters>Baligned_storage<proto::params::LocalizerParameters>(dummy_u[264c]a8)* ptional<proto::params::LocalizerParameters>Ref;
