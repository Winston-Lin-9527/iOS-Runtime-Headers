...
+(id)extractCardImage:(id)arg1 fromPixelBuffer:(CVBufferRef)arg2 withCardBuffer:(CVBufferRef)arg3 withPoints:(id)arg4 pixelFocalLength:(id)arg5 padding:(float)arg6 inputOrientation:(int)arg7 ;
