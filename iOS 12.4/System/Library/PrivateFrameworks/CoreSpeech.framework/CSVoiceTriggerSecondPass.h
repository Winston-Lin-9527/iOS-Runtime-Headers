...
#import <libobjc.A.dylib/CSVoiceTriggerFirstPassJarvisDelegate.h>
...
-(void)_handleVoiceTriggerFirstPassFromHearst:(unsigned long long)arg1 deviceId:(id)arg2 firstPassInfo:(id)arg3 completion:(/*^block*/id)arg4 ;
-(void)_handleVoiceTriggerFirstPassFromJarvis:(unsigned long long)arg1 deviceId:(id)arg2 firstPassInfo:(id)arg3 completion:(/*^block*/id)arg4 ;
