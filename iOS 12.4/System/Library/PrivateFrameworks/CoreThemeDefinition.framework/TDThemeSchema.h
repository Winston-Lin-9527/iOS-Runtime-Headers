...
-(void)_sanityCheckSchemaPartDefinitionsForStandardElement:(const SCD_Struct_TD16*)arg1 withElement:(id)arg2 ;
-(void)_addSchemaPartDefinitionsForStandardElement:(const SCD_Struct_TD16*)arg1 withElement:(id)arg2 ;
