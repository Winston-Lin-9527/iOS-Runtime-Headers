...
@property (assign,nonatomic) SCD_Struct_CS7 transformation;                                                    //@synthesize transformation=_transformation - In the implementation block
+(void)setFileEncoding:(int)arg1 ;
+(int)fileEncoding;
+(void)initialize;
-(void)addMetrics:(SCD_Struct_CS8)arg1 ;
...
-(void)setTransformation:(SCD_Struct_CS7)arg1 ;
