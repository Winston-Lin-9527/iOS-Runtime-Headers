...
@interface ASDaemonAccount : ASAccount <DADataclassLockWatcher, PCConnectionManagerDelegate> {
	...
	ASFolderChangedHistory* _noChangeHistory;
	BOOL _isNoChangeBlackListed;
	BOOL _safeToPing;
	...
	NSTimer* _pingBlacklistFolderSyncTimer;
	unsigned long long _pingBlacklistRetrySyncCount;
...
-(void)_refireBlacklistFolderIdsSync;
...
-(void)_triggerFolderContentsChangedNotification;
