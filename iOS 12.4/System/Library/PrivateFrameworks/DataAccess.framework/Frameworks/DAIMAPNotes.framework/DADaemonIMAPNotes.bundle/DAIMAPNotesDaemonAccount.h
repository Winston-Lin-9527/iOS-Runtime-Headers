...
-(void)_consumerQueueWrapper:(id)arg1 failedToRetrieveFolderListWithStatus:(long long)arg2 error:(id)arg3 ;
...
-(void)_consumerQueueWrapperSuccessfullyRetrievedFolderList:(id)arg1 ;
-(void)_noteInvocationFinished;
-(void)_reallySyncNotesFolderListWithConsumerQueueWrapper:(id)arg1 ;
-(int)outstandingInvocationCount;
-(void)setOutstandingInvocationCount:(int)arg1 ;
-(void)_syncNotesFolderListInLockWithConsumer:(id)arg1 queue:(id)arg2 ;
-(NSMutableArray *)notesNeedingBodyDownload;
-(id)fullyShutDownCallback;
-(void)setFullyShutDownCallback:(id)arg1 ;
-(void)syncNotesFolderListWithConsumer:(id)arg1 queue:(id)arg2 ;
