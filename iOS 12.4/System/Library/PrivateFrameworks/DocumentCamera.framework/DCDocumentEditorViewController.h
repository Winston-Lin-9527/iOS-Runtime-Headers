...
@class ICDocCamExtractedDocumentViewController, DCScannedDocument, ICDocCamDocumentInfoCollection, ICDocCamImageCache, NSIndexPath, UIImage, UIView, NSString;
...
@property (nonatomic,retain) DCScannedDocument * scannedDocument;                                                //@synthesize scannedDocument=_scannedDocument - In the implementation block
...
-(DCScannedDocument *)scannedDocument;
...
-(void)setScannedDocument:(DCScannedDocument *)arg1 ;
