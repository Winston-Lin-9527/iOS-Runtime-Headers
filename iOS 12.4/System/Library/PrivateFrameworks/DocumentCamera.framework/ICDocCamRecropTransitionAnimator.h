...
-(_GLKMatrix3)matrixTransformingQuadForOverlayToImageView:(BOOL*)arg1 ;
-(CGRect)containerViewFrame;
-(void)sortPoints:(CGPoint*)arg1 sorted:(CGPoint*)arg2 ;
-(_GLKMatrix3)matrixTransformingToUnitSquareWithPoints:(double)arg1 y0:(double)arg2 x1:(double)arg3 y1:(double)arg4 x2:(double)arg5 y2:(double)arg6 x3:(double)arg7 y3:(double)arg8 ;
