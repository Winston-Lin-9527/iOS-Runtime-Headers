...
+(id)featureFromConcompIndex:(int)arg1 session:(FKSession*)arg2 roiOffset:(CGPoint)arg3 dimensions:(CGSize)arg4 type:(long long)arg5 createDiacriticFeatures:(BOOL)arg6 featureID:(long long*)arg7 scale:(int)arg8 ;
+(id)featureFromSequenceIndex:(int)arg1 session:(FKSession*)arg2 roiOffset:(CGPoint)arg3 dimensions:(CGSize)arg4 createConcompFeatures:(BOOL)arg5 createDiacriticFeatures:(BOOL)arg6 featureID:(long long*)arg7 scale:(int)arg8 ;
