...
@property (assign,nonatomic) double mapsSuggestionsContactRevelanceScore;               //@synthesize mapsSuggestionsContactRevelanceScore=_mapsSuggestionsContactRevelanceScore - In the implementation block
@property (assign,nonatomic) BOOL hasMapsSuggestionsPoiRevelanceScore; 
@property (assign,nonatomic) double mapsSuggestionsPoiRevelanceScore;                   //@synthesize mapsSuggestionsPoiRevelanceScore=_mapsSuggestionsPoiRevelanceScore - In the implementation block
@property (assign,nonatomic) BOOL hasMapsSuggestionsIsTouristScore; 
@property (assign,nonatomic) double mapsSuggestionsIsTouristScore;                      //@synthesize mapsSuggestionsIsTouristScore=_mapsSuggestionsIsTouristScore - In the implementation block
