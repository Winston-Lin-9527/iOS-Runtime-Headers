...
@class GEOClientMetrics, GEOPDDatasetABStatus, NSString, NSMutableArray, GEOETAResult, GEOETAServiceResponseSummary, GEOPlaceSearchResponse;
...
@property (nonatomic,retain) NSString * debugData;                                              //@synthesize debugData=_debugData - In the implementation block
+(Class)etaResultType;
