...
-(id)findTransitLinksNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 handler:(/*^block*/id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(id)_findTransitPointsOfType:(unsigned long long)arg1 nearCoordinate:(SCD_Struct_GE30)arg2 radius:(double)arg3 handler:(/*^block*/id)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(void)_preloadTilesNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 tileSetStyle:(int)arg3 tileSize:(int)arg4 tileScale:(int)arg5 completionHandler:(/*^block*/id)arg6 ;
-(id)initWithQueue:(id)arg1 memoryCacheCountLimit:(unsigned long long)arg2 memoryCacheCostLimit:(unsigned long long)arg3 ;
-(id)findTransitStopsNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 handler:(/*^block*/id)arg3 completionHandler:(/*^block*/id)arg4 ;
-(id)findTransitHallsNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 handler:(/*^block*/id)arg3 completionHandler:(/*^block*/id)arg4 ;
-(id)findTransitStationsNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 handler:(/*^block*/id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)preloadRoadTilesNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)preloadTransitTilesNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)preloadBuildingTilesNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 completionHandler:(/*^block*/id)arg3 ;
-(id)roadTileKeysNear:(SCD_Struct_GE30)arg1 radius:(double)arg2 ;
