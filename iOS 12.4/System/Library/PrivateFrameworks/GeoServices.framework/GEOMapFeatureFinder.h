...
-(id)initWithMap:(id)arg1 center:(SCD_Struct_GE30)arg2 ;
-(void)_pickRoadInTile:(id)arg1 tileRect:(const SCD_Struct_GE44*)arg2 localPoint:(const Matrix<float, 2, 1>*)arg3 ;
