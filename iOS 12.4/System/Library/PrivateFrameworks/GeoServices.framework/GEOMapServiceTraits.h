...
@property (assign,nonatomic) BOOL supportsBrandFallback;                                          //@synthesize supportsBrandFallback=_supportsBrandFallback - In the implementation block
@property (assign,nonatomic) BOOL hasIsSettlement; 
@property (assign,nonatomic) BOOL isSettlement;                                                   //@synthesize isSettlement=_isSettlement - In the implementation block
@property (assign,nonatomic) BOOL hasIsRefund; 
@property (assign,nonatomic) BOOL isRefund;                                                       //@synthesize isRefund=_isRefund - In the implementation block
