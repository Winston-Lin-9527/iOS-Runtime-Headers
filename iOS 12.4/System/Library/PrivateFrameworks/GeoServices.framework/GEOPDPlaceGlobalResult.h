...
@property (nonatomic,retain) GEOPDBatchCategoryLookupResult * batchCategoryLookupResult;                                                                //@synthesize batchCategoryLookupResult=_batchCategoryLookupResult - In the implementation block
