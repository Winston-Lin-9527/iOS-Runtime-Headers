...
@property (assign,nonatomic) BOOL supportCoordinatesOnlyRefinement;                   //@synthesize supportCoordinatesOnlyRefinement=_supportCoordinatesOnlyRefinement - In the implementation block
...
-(id)initWithMuid:(unsigned long long)arg1 locationHint:(SCD_Struct_GE30)arg2 placeNameHint:(id)arg3 resultProviderId:(int)arg4 ;
-(id)initWithMapItemToRefine:(id)arg1 coordinate:(SCD_Struct_GE30)arg2 ;
