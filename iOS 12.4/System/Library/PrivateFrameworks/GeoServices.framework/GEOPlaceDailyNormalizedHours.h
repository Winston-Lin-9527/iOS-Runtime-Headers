...
@property (readonly) long long weekday;                                       //@synthesize weekday=_weekday - In the implementation block
@property (readonly) NSArray * localTimeIntervals;                            //@synthesize localTimeIntervals=_localTimeIntervals - In the implementation block
...
@property (readonly) BOOL openToMidnight;                                     //@synthesize openToMidnight=_openToMidnight - In the implementation block
@property (readonly) BOOL openFromMidnight;                                   //@synthesize openFromMidnight=_openFromMidnight - In the implementation block
