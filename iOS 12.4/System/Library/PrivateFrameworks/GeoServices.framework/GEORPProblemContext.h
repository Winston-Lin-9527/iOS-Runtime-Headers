...
@class NSMutableArray, GEOABAssignmentResponse, GEORPCurrentEnvironmentManifestURLs, NSString, GEORPMapLocation, GEORPMerchantLookupContext, GEORPNavigationSettings, GEOPlace, GEORPPersonalizedMaps, GEOPDPlace, GEORPPlaceInfo, GEOServicesState, GEORPTransitLineTileInfo;
...
@property (nonatomic,retain) GEORPMerchantLookupContext * merchantLookupContext;                                //@synthesize merchantLookupContext=_merchantLookupContext - In the implementation block
