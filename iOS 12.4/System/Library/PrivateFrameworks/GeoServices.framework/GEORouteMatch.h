...
@interface GEORouteMatch : NSObject {
	...
	SCD_Struct_GE30 _locationCoordinate;
...
@property (assign,nonatomic) SCD_Struct_GE30 locationCoordinate;                                     //@synthesize locationCoordinate=_locationCoordinate - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_GE69* road;                                                  //@synthesize road=_road - In the implementation block
...
-(SCD_Struct_GE30)locationCoordinate;
-(id)initWithRoute:(id)arg1 routeCoordinate:(PolylineCoordinate)arg2 locationCoordinate:(SCD_Struct_GE30)arg3 stepIndex:(unsigned long long)arg4 matchedCourse:(double)arg5 timestamp:(id)arg6 ;
-(void)setRoad:(SCD_Struct_GE69*)arg1 ;
...
-(void)setLocationCoordinate:(SCD_Struct_GE30)arg1 ;
