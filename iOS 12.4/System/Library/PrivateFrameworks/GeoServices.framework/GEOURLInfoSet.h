...
@property (nonatomic,retain) GEOURLInfo * analyticsCohortSessionURL;                  //@synthesize analyticsCohortSessionURL=_analyticsCohortSessionURL - In the implementation block
@property (nonatomic,readonly) BOOL hasAnalyticsLongSessionURL; 
@property (nonatomic,retain) GEOURLInfo * analyticsLongSessionURL;                    //@synthesize analyticsLongSessionURL=_analyticsLongSessionURL - In the implementation block
@property (nonatomic,readonly) BOOL hasAnalyticsShortSessionURL; 
@property (nonatomic,retain) GEOURLInfo * analyticsShortSessionURL;                   //@synthesize analyticsShortSessionURL=_analyticsShortSessionURL - In the implementation block
@property (nonatomic,readonly) BOOL hasAnalyticsSessionlessURL; 
@property (nonatomic,retain) GEOURLInfo * analyticsSessionlessURL;                    //@synthesize analyticsSessionlessURL=_analyticsSessionlessURL - In the implementation block
