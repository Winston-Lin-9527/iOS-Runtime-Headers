...
@interface GEOVectorTile : NSObject {
	...
	SCD_Struct_GE147* _threeDBuildings;
	unsigned long long _threeDBuildingsCount;
	SCD_Struct_GE147* _overlapThreeDBuildings;
	unsigned long long _overlapThreeDBuildingsCount;
	SCD_Struct_GE148* _extendedPointAttributes;
	unsigned long long _extendedPointAttributesCount;
	SCD_Struct_GE43* _pois;
	...
	SCD_Struct_GE141* _lineVertices;
	SCD_Struct_GE141* _polygonVertices;
	SCD_Struct_GE141* _coastlineVertices;
	SCD_Struct_GE141* _footprintVertices;
	SCD_Struct_GE141* _overlapFootprintVertices;
	SCD_Struct_GE141* _hiResFootprintVertices;
	SCD_Struct_GE141* _venuesVertices;
	...
	SCD_Struct_GE141* _transitVertices;
	...
	SCD_Struct_GE140* _transitLinkLabelAnnotations;
	unsigned long long _transitLinkLabelAnnotationCount;
	SCD_Struct_GE141* _transitLinkAnnotationBezierVertices;
	...
	SCD_Struct_GE42* _transitLinkSections;
...
@property (nonatomic,readonly) SCD_Struct_GE147* threeDBuildings; 
@property (nonatomic,readonly) SCD_Struct_GE147* overlapThreeDBuildings; 
@property (nonatomic,readonly) SCD_Struct_GE69* lines;                                                //@synthesize lines=_lines - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* linesLabelAnnotations;                               //@synthesize linesLabelAnnotations=_linesLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE141* linesAnnotationBezierVertices;                       //@synthesize linesAnnotationBezierVertices=_linesAnnotationBezierVertices - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE69* coastlines;                                           //@synthesize coastlines=_coastlines - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE142* polygons;                                            //@synthesize polygons=_polygons - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE143* venues;                                              //@synthesize venues=_venues - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE144* venueBuildings;                                      //@synthesize venueBuildings=_venueBuildings - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE141* venueVertices;                                       //@synthesize venuesVertices=_venuesVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE145* venueLevels;                                         //@synthesize venueLevels=_venueLevels - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE146* venueComponents;                                     //@synthesize venueComponents=_venueComponents - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE43* pois;                                                 //@synthesize pois=_pois - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE136* junctions;                                           //@synthesize junctions=_junctions - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE141* lineVertices; 
...
@property (nonatomic,readonly) SCD_Struct_GE141* transitVertices;                                     //@synthesize transitVertices=_transitVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE141* transitStationTransferVertices;                      //@synthesize transitStationTransferVertices=_transitStationTransferVertices - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE136* transitJunctions;                                    //@synthesize transitJunctions=_transitJunctions - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE140* transitLinkLabelAnnotations;                         //@synthesize transitLinkLabelAnnotations=_transitLinkLabelAnnotations - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE141* transitLinkAnnotationBezierVertices;                 //@synthesize transitLinkAnnotationBezierVertices=_transitLinkAnnotationBezierVertices - In the implementation block
...
@property (nonatomic,readonly) const SCD_Struct_GE42* transitLinkSections;                            //@synthesize transitLinkSections=_transitLinkSections - In the implementation block
...
-(SCD_Struct_GE69*)lines;
-(void)forEachEdgeOnJunction:(const SCD_Struct_GE136*)arg1 visitor:(/*^block*/id)arg2 ;
-(void)forEachEdgeInRoad:(SCD_Struct_GE69*)arg1 visitTwice:(BOOL)arg2 visitor:(/*^block*/id)arg3 ;
-(void)forEachRoad:(/*^block*/id)arg1 ;
-(unsigned long long)totalBuildingFootprintsCount;
-(SCD_Struct_GE141*)transitVertices;
-(unsigned long long)linesCount;
-(void)forEachPoint:(/*^block*/id)arg1 ;
-(void)forEachPolygon:(/*^block*/id)arg1 ;
-(void)forEachTransitLinkOnJunction:(const SCD_Struct_GE136*)arg1 visitor:(/*^block*/id)arg2 ;
...
-(SCD_Struct_GE43*)pois;
-(unsigned long long)poisCount;
-(SCD_Struct_GE142*)polygons;
...
-(id)baseHeightsPool;
-(SCD_Struct_GE42*)polygonLabelPositions;
-(void)forEachJunction:(/*^block*/id)arg1 ;
-(void)forEachJunctionInRoad:(SCD_Struct_GE69*)arg1 visitor:(/*^block*/id)arg2 ;
-(unsigned long long)linesVertexCount;
-(unsigned long long)polygonsVertexCount;
-(SCD_Struct_GE69*)multiSectionFeatureForGeoID:(unsigned long long)arg1 ;
...
-(SCD_Struct_GE140*)linesLabelAnnotations;
-(unsigned long long)linesLabelAnnotationCount;
-(SCD_Struct_GE141*)linesAnnotationBezierVertices;
-(SCD_Struct_GE69*)coastlines;
-(unsigned long long)coastlinesCount;
-(SCD_Struct_GE143*)venues;
-(unsigned long long)venuesCount;
-(SCD_Struct_GE144*)venueBuildings;
-(unsigned long long)venueBuildingsCount;
-(SCD_Struct_GE145*)venueLevels;
-(unsigned long long)venueLevelsCount;
-(SCD_Struct_GE146*)venueComponents;
-(unsigned long long)venueComponentsCount;
-(SCD_Struct_GE141*)venueVertices;
...
-(SCD_Struct_GE140*)transitLinkLabelAnnotations;
-(unsigned long long)transitLinkLabelAnnotationCount;
-(SCD_Struct_GE141*)transitLinkAnnotationBezierVertices;
-(unsigned long long*)transitShieldIndices;
-(unsigned char*)transitLineDirections;
-(const SCD_Struct_GE42*)transitLinkSections;
...
-(SCD_Struct_GE147*)threeDBuildings;
-(SCD_Struct_GE147*)overlapThreeDBuildings;
...
-(BOOL)_decodeTransitLabelsFromStream:(SCD_Struct_GE168*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE41*)arg3 featureStride:(unsigned long long)arg4 ;
-(BOOL)_decodeLabelTextPlacementsFromStream:(SCD_Struct_GE168*)arg1 count:(unsigned long long)arg2 firstFeature:(SCD_Struct_GE43*)arg3 featureStride:(unsigned long long)arg4 tilePrecision:(unsigned char)arg5 ;
...
-(BOOL)_readExtendedPointAttributes:(SCD_Struct_GE167*)arg1 ;
...
-(BOOL)_readRoadNetwork:(SCD_Struct_GE167*)arg1 ;
-(void)dealloc;
-(id)description;
@end
