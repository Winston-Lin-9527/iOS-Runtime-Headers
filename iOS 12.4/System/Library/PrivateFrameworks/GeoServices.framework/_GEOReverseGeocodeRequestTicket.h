...
@class NSString, GEOMapServiceTraits, GEOMapRegion, NSArray, GEORelatedSearchSuggestion, NSDictionary, GEOResolvedItem, GEODirectionIntent, GEOPDMerchantLookupResult;
