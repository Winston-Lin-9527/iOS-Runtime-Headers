...
@property (readonly) int htseEnablementPeriodDays;                                               //@synthesize htseEnablementPeriodDays=_htseEnablementPeriodDays - In the implementation block
@property (readonly) BOOL htseKillSwitch;                                                        //@synthesize htseKillSwitch=_htseKillSwitch - In the implementation block
@property (readonly) double htseTimeoutTimestampSec;                                             //@synthesize htseTimeoutTimestampSec=_htseTimeoutTimestampSec - In the implementation block
