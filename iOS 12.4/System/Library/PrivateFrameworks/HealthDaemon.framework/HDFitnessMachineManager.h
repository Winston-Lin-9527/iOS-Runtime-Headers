...
@class HDProfile, NSObject, NSMutableArray, HDFitnessMachineDataCollector, HDFitnessMachinePairingManager, HDFitnessMachineSession, HKObserverSet, HDFitnessMachineDataProducer, NSDate, HDHealthServiceManager, HDFitnessMachineStateTimers, HDFitnessMachineAnalyticsCollector, NSString;
