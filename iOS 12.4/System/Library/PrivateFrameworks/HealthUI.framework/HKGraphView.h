...
@class NSMutableArray, HKPropertyAnimationApplier, HKValueRange, UIImage, UIView, UIScrollView, HKBorderLineView, HKAxis, UIColor, HKGraphViewSelectionStyle, HKMultiTouchPressGestureRecognizer, NSSet, HKOutsideViewTapDetector, NSMutableDictionary, NSArray, NSString;
...
-(SCD_Struct_HK15)_closestDataPointPathToPoint:(CGPoint)arg1 seriesGroupRow:(long long)arg2 seriesInGroup:(id)arg3 minimumXDistance:(double)arg4 xDistanceOut:(double*)arg5 ;
...
-(SCD_Struct_HK15)_closestDataPointPathToPoint:(CGPoint)arg1 seriesGroupRow:(long long)arg2 minimumXDistance:(double)arg3 xDistanceOut:(double*)arg4 ;
