...
@property (assign,nonatomic) BOOL respondsToRequestResumed;                                        //@synthesize respondsToRequestResumed=_respondsToRequestResumed - In the implementation block
@property (assign,nonatomic) BOOL respondsToRequestCompleted;                                      //@synthesize respondsToRequestCompleted=_respondsToRequestCompleted - In the implementation block
