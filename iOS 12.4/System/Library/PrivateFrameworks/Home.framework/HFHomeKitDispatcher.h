...
#import <libobjc.A.dylib/HMTelevisionProfileDelegate.h>
...
@property (nonatomic,retain) NSHashTable * televisionObservers;                               //@synthesize televisionObservers=_televisionObservers - In the implementation block
...
-(NSHashTable *)televisionObservers;
-(HMHome *)selectedHome;
...
-(void)setTelevisionObservers:(NSHashTable *)arg1 ;
