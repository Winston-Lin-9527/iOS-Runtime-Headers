...
@class HMFPairingIdentity, NSMutableArray, NSString, HMDCharacteristic, NSNumber, NSData, NSDate, NSArray, HMDTargetControllerManager, HMDAccessorySymptomHandler, HMFConnectivityInfo, HMFTimer, NSMutableSet, NSSet, HMDDataStreamController, HMDPendingCharacteristic, NSMapTable;
