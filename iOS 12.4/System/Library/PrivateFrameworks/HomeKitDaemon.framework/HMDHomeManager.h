...
@class HMDKeyTransferAgent, HMDSoftwareUpdateManager, HMDHomeManagerObjectLookup, HMFTimer, HMDCompanionManager, NSMutableDictionary, NSMutableArray, NSDictionary, NSMutableSet, HMDAccessoryBrowser, HMDHomeManagerObjectChangeHandler, NSUUID, NSObject, HMFMessageDispatcher, HMDCentralMessageDispatcher, HMDPairedSync, HMDNameValidator, HMDPendingCloudSyncTransactions, HMDPowerManager, HMDCloudManager, HMDWatchManager, HMDBackingStore, HMDMessageFilterChain, HMDIdentityRegistry, HMDCloudDataSyncStateFilter, HMDLocation, HMDFMFHandler, HMDApplicationRegistry, HMDAccountRegistry, HMFDumpCategory, HMDClientConnection, HMDAssistantGather, HMDTimeInformationMonitor, HMDApplicationData, HMDResidentMesh, HMDSyncOperationManager, HMDCloudAccount, HMDAWDLogEventObserver, HMDDevice, NSString;

@interface HMDHomeManager : HMFObject <HMDCompanionManagerDelegate, HMDCompanionManagerDelegate, HMDDeviceSetupSessionDelegate, HMDWatchManagerDelegate, HMFMessageReceiver, HMDAccessoryBrowserManagerDelegate, HMFTimerDelegate, HAPFragmentationStreamDelegate, HMDPairedSyncDelegate, HMDUserManagementOperationDelegate, HMDBackingStoreObjectProtocol> {
