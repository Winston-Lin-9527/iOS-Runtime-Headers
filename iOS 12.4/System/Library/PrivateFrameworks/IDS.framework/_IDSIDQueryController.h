...
-(void)_requestStatusForDestinations:(id)arg1 service:(id)arg2 forceRefresh:(BOOL)arg3 listenerID:(id)arg4 completionBlock:(/*^block*/id)arg5 ;
...
-(void)_idStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 allowRenew:(BOOL)arg4 forceRefresh:(BOOL)arg5 completionBlock:(/*^block*/id)arg6 ;
-(BOOL)_refreshIDStatusForDestinations:(id)arg1 service:(id)arg2 listenerID:(id)arg3 allowRefresh:(BOOL)arg4 forceRefresh:(BOOL)arg5 queue:(id)arg6 completionBlock:(/*^block*/id)arg7 ;
