...
@interface OSLogEventProxy : NSObject <OSLogEventProvider> {
	...
	SCD_Struct_OS14* _eint;
	os_activity_map_sRef _aid_map;
	SCD_Struct_OS19* _event;
...
-(BOOL)_setLogEvent:(SCD_Struct_OS19*)arg1 rangeUUIDIndex:(unsigned long long)arg2 machTimebase:(mach_timebase_info*)arg3 ;
