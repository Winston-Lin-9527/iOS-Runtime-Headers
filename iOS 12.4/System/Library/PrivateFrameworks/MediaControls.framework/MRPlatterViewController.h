...
@class UIView, MPAVRoutingViewController, NSString, MTVibrantStylingProvider, MRMediaControlsVideoPickerFooterView, MRMediaControlsVideoPickerHeaderView, MediaControlsRoutingCornerView, MediaControlsParentContainerView, MediaControlsVolumeContainerView, NSMutableArray, MPArtworkCatalog, MPVolumeGroupSliderCoordinator, MPAVEndpointRoute, MediaControlsTransitioningDelegate, MediaControlsLanguageOptionsViewController, MPMediaControls, FBSDisplayLayoutMonitor, NSArray, MediaControlsEndpointController, MediaControlsHeaderView;
