...
@class MPAVOutputDeviceRoutingDataSource, MPMediaControlsConfiguration, MediaControlsEndpointsManager, MPAVRoutingViewController, MPAVEndpointRoute, NSString, AVExternalPlaybackMonitor;
