...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT32 _vertexBuffers[36];
	SCD_Struct_MT32 _vertexTextures[31];
	SCD_Struct_MT32 _vertexSamplers[16];
	SCD_Struct_MT32 _fragmentBuffers[31];
	SCD_Struct_MT32 _fragmentTextures[31];
	SCD_Struct_MT32 _fragmentSamplers[16];
	SCD_Struct_MT32 _tileBuffers[31];
	SCD_Struct_MT32 _tileTextures[31];
	SCD_Struct_MT32 _tileSamplers[16];
	SCD_Struct_MT32 _threadgroupMemoryArguments[31];
	SCD_Struct_MT154 _limits;
	...
	SCD_Struct_MT32 _tessellationFactorBufferArgument;
...
@property (nonatomic,readonly) SCD_Struct_MT1 viewport; 
@property (nonatomic,readonly) SCD_Struct_MT153 scissorRect; 
...
@property (nonatomic,readonly) SCD_Struct_MT32 tessellationFactorBufferArgument;                       //@synthesize tessellationFactorBufferArgument=_tessellationFactorBufferArgument - In the implementation block
...
-(void)setViewports:(const SCD_Struct_MT1*)arg1 count:(unsigned long long)arg2 ;
...
-(void)setScissorRect:(SCD_Struct_MT153)arg1 ;
-(void)setScissorRects:(const SCD_Struct_MT153*)arg1 count:(unsigned long long)arg2 ;
...
-(void)dispatchThreadsPerTile:(SCD_Struct_MT33)arg1 ;
...
-(SCD_Struct_MT153)scissorRect;
-(SCD_Struct_MT1)viewport;
...
-(SCD_Struct_MT32)tessellationFactorBufferArgument;
