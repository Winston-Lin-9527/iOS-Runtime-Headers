...
+(void)resourceTrackingRecordAccessesToArguments:(id)arg1 bufferFuncArgsPtr:(SCD_Struct_MT0*)arg2 textureFuncArgsPtr:(SCD_Struct_MT0*)arg3 buffersBoundForWrite:(id)arg4 texturesBoundForWrite:(id)arg5 ;
+(BOOL)hasValidViewports:(SCD_Struct_MT1*)arg1 viewportCount:(unsigned)arg2 scissorRects:(SCD_Struct_MT2*)arg3 scissorRectCount:(unsigned)arg4 ;
