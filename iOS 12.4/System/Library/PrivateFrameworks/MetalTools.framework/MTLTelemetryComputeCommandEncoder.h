...
-(void)accumDispatchDistribution:(unsigned long long)arg1 threadgroupsPerGrid:(SCD_Struct_MT33)arg2 threadsPerThreadgroup:(SCD_Struct_MT33)arg3 threadsPerGrid:(SCD_Struct_MT33)arg4 ;
