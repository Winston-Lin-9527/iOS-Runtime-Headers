...
-(void)accumViewportTelemetry:(const SCD_Struct_MT1*)arg1 count:(unsigned long long)arg2 ;
-(void)accumScissorRectTelemetry:(const SCD_Struct_MT153*)arg1 count:(unsigned long long)arg2 ;
-(void)endEncoding;
