...
@property (nonatomic,retain) NSMutableArray * currentExpressPasseInformations;              //@synthesize currentExpressPasseInformations=_currentExpressPasseInformations - In the implementation block
...
-(NSMutableArray *)currentExpressPasseInformations;
-(void)setCurrentExpressPasseInformations:(NSMutableArray *)arg1 ;
