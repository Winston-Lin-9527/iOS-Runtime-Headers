...
@class NTKColoringImageView, NSNumber, NSTimer, CALayer, CLKDevice, NTKHandView, NSDate, NSCalendar, UIColor, NSString;
...
@property (nonatomic,retain) CALayer * minuteHandDot;                                 //@synthesize minuteHandDot=_minuteHandDot - In the implementation block
...
-(CALayer *)minuteHandDot;
-(void)setMinuteHandDot:(CALayer *)arg1 ;
