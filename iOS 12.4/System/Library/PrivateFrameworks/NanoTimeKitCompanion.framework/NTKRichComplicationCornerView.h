...
+(id)layoutRuleForState:(long long)arg1 position:(long long)arg2 faceBounds:(CGRect)arg3 forDevice:(id)arg4 ;
...
+(UIEdgeInsets)_keylinePaddingForPosition:(long long)arg1 conentSize:(CGSize)arg2 forDevice:(id)arg3 ;
