...
@required
-(id)renderImage:(id)arg1 rect:(SCD_Struct_NU2)arg2 toDestination:(id)arg3 atPoint:(SCD_Struct_NU1)arg4 error:(out id*)arg5;
...
-(id)_renderImage:(id)arg1 rect:(SCD_Struct_NU2)arg2 toDestination:(id)arg3 atPoint:(SCD_Struct_NU1)arg4 error:(out id*)arg5 ;
