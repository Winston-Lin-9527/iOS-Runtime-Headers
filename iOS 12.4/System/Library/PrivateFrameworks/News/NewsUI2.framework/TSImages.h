...
+(id)iconFollowingOnHeart;
+(id)iconFollowingOnCircle;
+(id)iconFollowingOffCircle;
+(id)iconFollowingOffCircleDarkTranslucent;
+(id)iconFollowingOffCircleLightTranslucent;
-(id)init;
@end
