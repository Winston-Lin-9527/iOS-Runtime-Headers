...
@class NSString, NSDate, FCHeadlineThumbnail, NSURL, NSArray, FCCoverArt, NSSet, FCFeedPersonalizedItemScoreProfile, FCTopStoriesStyleConfiguration, NSData, FCHeadlineExperimentalTitleMetadata, FCIssue, NTPBFeedViewportHeadline, FCSharedStringIndex, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList;
