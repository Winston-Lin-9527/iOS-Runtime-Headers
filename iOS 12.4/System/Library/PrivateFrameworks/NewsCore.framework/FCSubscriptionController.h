...
@class FCSubscriptionList, FCTagController, FCThreadSafeMutableDictionary, FCThreadSafeMutableSet, NSHashTable, FCNotificationController, FCPurchaseController, NSString;
