...
@class NSDate, NSString, FCAssetHandle, FCColor, NSArray, NTPBPublisherPaidDescriptionStrings, NSData, FCTagBanner, FCTextInfo, FCHeadlineTemplate, FCInterestToken, NTPBFeedConfiguration, NTPBTagRecord;
