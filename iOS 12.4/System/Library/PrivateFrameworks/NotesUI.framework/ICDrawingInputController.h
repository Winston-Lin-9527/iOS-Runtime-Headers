...
-(void)drawingUpdatePoint:(SCD_Struct_IC14)arg1 ;
...
-(void)_drawingAddPoint:(SCD_Struct_IC14)arg1 ;
...
-(SCD_Struct_IC15)baseValuesforCommandType:(unsigned)arg1 inputType:(long long)arg2 ;
-(SCD_Struct_IC16)parametersforCommandType:(unsigned)arg1 ;
-(double)baseRadiusForCommandType:(unsigned)arg1 inputType:(long long)arg2 ;
-(double)rulerOffset;
-(SCD_Struct_IC15)outputCurrentCommandPoint:(SCD_Struct_IC14)arg1 ;
-(SCD_Struct_IC15)outputPoint:(SCD_Struct_IC14)arg1 forCommandType:(unsigned)arg2 baseValues:(SCD_Struct_IC15)arg3 ;
-(SCD_Struct_IC15)penOutputPoint:(SCD_Struct_IC14)arg1 baseValues:(SCD_Struct_IC15)arg2 ;
-(SCD_Struct_IC15)pencilOutputPoint:(SCD_Struct_IC14)arg1 baseValues:(SCD_Struct_IC15)arg2 ;
-(SCD_Struct_IC15)markerOutputPoint:(SCD_Struct_IC14)arg1 baseValues:(SCD_Struct_IC15)arg2 ;
-(void)handleMarkerStartCapPoint:(SCD_Struct_IC15*)arg1 forInput:(SCD_Struct_IC14*)arg2 ;
-(SCD_Struct_IC15)eraserOutputPoint:(SCD_Struct_IC14)arg1 baseValues:(SCD_Struct_IC15)arg2 ;
-(SCD_Struct_IC14)calculateVelocityForNewPoint:(SCD_Struct_IC14)arg1 previousPoint:(SCD_Struct_IC14)arg2 ;
-(SCD_Struct_IC14)calculateVelocityForFirstPoint:(SCD_Struct_IC14)arg1 ;
...
-(void)drawingAddPoint:(SCD_Struct_IC14)arg1 ;
