...
@protocol OS_dispatch_queue, OS_dispatch_group, PDCloudStoreContainerDelegate, PDCloudStoreDataSource;
@class NSMutableSet, NSObject, CKContainer, NSArray, NSMutableDictionary, NSError, NSString;
...
-(void)invalidateCloudStoreWithOperationGroupNameSuffix:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)invalidateCloudStoreWithCompletion:(/*^block*/id)arg1 ;
-(NSArray *)zoneNames;
