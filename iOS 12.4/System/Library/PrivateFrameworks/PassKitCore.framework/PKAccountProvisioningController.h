...
@class NPKCompanionAgentConnection, PKAccountService, PKAccountCredential, PKPaymentProvisioningController, NSObject, NSString;
...
@property (nonatomic,readonly) unsigned long long addToVPANState;                                        //@synthesize addToVPANState=_addToVPANState - In the implementation block
