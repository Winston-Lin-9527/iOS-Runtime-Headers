...
@class NSMutableSet, NSTimer, NSMutableArray, NSString, PKPaymentCredential, NSHashTable, NSLock, NSSet, PKPaymentSetupMoreInfoItem, CLLocationManager, NSObject, PKPaymentWebService, NSArray, PKPaymentProvisioningControllerCredentialQueue, PKPaymentSetupProductModel, PKPaymentRequirementsResponse, PKPaymentEligibilityResponse, PKPaymentProvisioningResponse, PKPaymentPass;
...
-(void)retrieveAllAvaialbleCredentials:(/*^block*/id)arg1 ;
