...
@class NSString, NSDecimalNumber, NSDate, PKMerchant, NSTimeZone, NSData, PKPaymentTransactionForeignExchangeInformation, PKPaymentTransactionFees, NSUUID, PKPaymentTransactionRewards, NSSet, NSOrderedSet, NSArray, PKAccountEvent, NSDictionary, PKCurrencyAmount, CLLocation;
