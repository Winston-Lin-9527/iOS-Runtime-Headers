...
@class PKPaymentWebService, NSMutableArray, PKPaymentService, NSArray, NSMutableSet, PKAccount, NSObject, NSString, DIVerificationSession, PKAssertion, PKFeatureApplication, PKPaymentProvisioningController;
...
-(void)termsDataForFeatureWithFormat:(id)arg1 completion:(/*^block*/id)arg2 ;
