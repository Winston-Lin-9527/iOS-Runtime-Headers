...
@class _UIBackdropView, UIView, LAUIPhysicalButtonView, UILabel, UIStackView, PKContinuityPaymentCardSummaryView, PKPaymentAuthorizationFooterView, PKContinuityPaymentFaviconView, UIViewController, NSArray, PKAuthenticator, PKPaymentAuthorizationStateMachine, NSTimer, PKRemotePaymentRequest, NSString;
