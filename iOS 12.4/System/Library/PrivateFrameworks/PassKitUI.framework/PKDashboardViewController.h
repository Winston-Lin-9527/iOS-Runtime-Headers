...
@property (nonatomic,readonly) BOOL navigationBarVisible;                            //@synthesize navigationBarVisible=_navigationBarVisible - In the implementation block
...
@property (assign,nonatomic) BOOL shouldAnimateNavigationBarAppearance;              //@synthesize shouldAnimateNavigationBarAppearance=_shouldAnimateNavigationBarAppearance - In the implementation block
@property (assign,nonatomic) double navigationBarVisiblityTopInset;                  //@synthesize navigationBarVisiblityTopInset=_navigationBarVisiblityTopInset - In the implementation block
