...
@class PKDiscoveryArticleAnimatedTransitioningHandler, PKDiscoveryArticleLayout, PKContinuousButton, UIActivityIndicatorView, UILabel, NSString, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, NSMutableDictionary, NSObject, PKDiscoveryCardView, UICollectionView;
