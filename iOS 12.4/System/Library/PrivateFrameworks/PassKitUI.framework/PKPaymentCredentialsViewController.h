...
@class PKPaymentProvisioningController, NSMutableArray, PKPaymentCredentialCache, PKTableHeaderView, PKPaymentSetupFooterView, UIImage, PKPaymentCredentialTableViewCell, PKPaymentSetupProduct, NSString;
