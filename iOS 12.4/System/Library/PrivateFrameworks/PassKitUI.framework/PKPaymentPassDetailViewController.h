...
@class NSObject, PKPaymentPass, PKLinkedApplication, PKPaymentApplication, PKPaymentWebService, PKPaymentVerificationController, PKPaymentPassDetailActivationFooterView, UIRefreshControl, PKSettingTableCell, PKPaymentTransactionCellController, NSArray, NSDateFormatter, NSNumberFormatter, PKDashboardTransactionFetcher, LAContext, PKExpressPassController, PKTransitPassProperties, PKPaymentBalanceReminder, NSDictionary, NSMutableDictionary, NSNumber, UIView, UIImageView, PKPassHeaderView, UISegmentedControl, PKAnimatedNavigationBarTitleView, PKPassFaceViewRendererState, PKPeerPaymentWebService, PKPeerPaymentController, PKPeerPaymentAccount, PKPeerPaymentContactResolver, PKPeerPaymentPreferences, PKSpinnerHeaderView, PKPeerPaymentActionViewController, PKPaymentTransactionDetailsFactory, PKAccountServiceAccountResolutionController, PKAccountServicePerformActionViewController, PKAccountService, PKAccount, PKPhysicalCardController, PKPhysicalCardActionController, PKPeerPaymentAccountResolutionController, PKBusinessChatController, NSIndexPath, PKTransitBalanceModel, CNContact, CLInUseAssertion, NSMutableArray, PKPassPresentationContext, UIColor, NSString;
