...
@class PKPaymentTransaction, PKPaymentTransactionCellController, PKPaymentPass, PKPaymentTransactionDetailHeaderView, PKPeerPaymentContactResolver, PKPeerPaymentController, UIImage, NSArray, PKPeerPaymentStatusResponse, NSDateFormatter, NSTimeZone, PKTransactionDetailBottomContainer, NSString;
...
@property (nonatomic,retain) PKTransactionDetailBottomContainer * bottomContainer;                 //@synthesize bottomContainer=_bottomContainer - In the implementation block
...
-(PKTransactionDetailBottomContainer *)bottomContainer;
-(void)setBottomContainer:(PKTransactionDetailBottomContainer *)arg1 ;
