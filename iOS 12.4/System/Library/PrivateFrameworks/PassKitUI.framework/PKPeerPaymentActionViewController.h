...
@class PKPassSnapshotter, PKPeerPaymentAccount, PKPeerPaymentActionController, PKPeerPaymentWebService, PKPaymentPass, NSDecimalNumber, UIImageView, PKPeerPaymentAccountFeatureDescriptor, NSString;
