...
@class PKPaymentTransaction, PKPaymentPass, PKAccount, PKPaymentService, PKPaymentTransactionCellController, PKBusinessChatController, UIBarButtonItem, NSString, UIView, UIImageView;
