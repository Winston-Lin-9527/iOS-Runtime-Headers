...
@class PLCloudBatchUploader, PLCloudBatchDownloader, NSObject, PLBatterySaverWatcher, PLForegroundMonitor, PLPhotoLibrary, CPLLibraryManager, PLCloudTaskManager, PLCloudResourceManager, NSDate, PFCoalescer, PLCloudInMemoryTaskManager, PLCloudPhotoLibraryUploadTracker, NSMutableDictionary, PLCloudPhotoLibraryUserSwitchHandler, NSNumber, NSString;
