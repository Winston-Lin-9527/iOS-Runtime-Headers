...
@class UILabel, NSArray, UIImageView, UIButton, PLPlatterHeaderContentViewLayoutManager, MTVibrantStylingProvider, NSString, NSDate, NSTimeZone, UIView, BSUIFontProvider, UIFont;
