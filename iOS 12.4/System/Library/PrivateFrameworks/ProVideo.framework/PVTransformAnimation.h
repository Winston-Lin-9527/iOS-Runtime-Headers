...
@interface PVTransformAnimation : NSObject <NSSecureCoding> {
	...
	SCD_Struct_PV25 _presentationTimeRange;

}

@property (nonatomic,readonly) NSArray * animationData;                          //@synthesize animationData=_animationData - In the implementation block
@property (assign,nonatomic) SCD_Struct_PV25 presentationTimeRange;              //@synthesize presentationTimeRange=_presentationTimeRange - In the implementation block
...
-(SCD_Struct_PV25)presentationTimeRange;
-(void)setPresentationTimeRange:(SCD_Struct_PV25)arg1 ;
