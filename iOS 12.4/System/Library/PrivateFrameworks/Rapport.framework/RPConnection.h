...
@class NSString, NSObject, NSError, NSData, CUPairingStream, CUPairingSession, NSDictionary, CUBLEConnection, NSUUID, CUBonjourDevice, CUBluetoothScalablePipe, RPIdentity, CUHomeKitManager, RPIdentityDaemon, RPCompanionLinkDevice, RPMetrics, CUNetLinkManager, CUTCPConnection;
...
@property (nonatomic,retain) RPMetrics * metrics;                                     //@synthesize metrics=_metrics - In the implementation block
...
-(void)invalidate;
-(void)setMetrics:(RPMetrics *)arg1 ;
-(RPMetrics *)metrics;
-(void)_invalidate;
-(void)activate;
-(NSString *)label;
