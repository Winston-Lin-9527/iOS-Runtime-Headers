...
@class CUBonjourAdvertiser, CUBonjourBrowser, CUCoalescer, CUBonjourDevice, RPConnection, NSObject, RPIdentity, CUTCPServer, CUWiFiManager, NSMutableArray, NSString, NSData, RPFileTransferProgress, NSURL;
