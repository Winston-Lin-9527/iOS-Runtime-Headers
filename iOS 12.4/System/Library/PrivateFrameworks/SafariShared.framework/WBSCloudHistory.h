...
@class NSObject, WBSHistory, WBSCloudHistoryConfiguration, WBSCloudKitThrottler, WBSOneShotTimer, WBSCloudHistoryPushAgentProxy, NSMutableDictionary, NSString;
