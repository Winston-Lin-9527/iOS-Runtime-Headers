...
-(void)populateReferencesUsingPAStyleSerializedMountStatusTracker:(const SCD_Struct_SA21*)arg1 andDeserializationDictionary:(id)arg2 andDataBufferDictionary:(id)arg3 ;
