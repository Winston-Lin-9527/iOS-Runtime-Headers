...
@property (nonatomic,retain) PSSpecifier * showingPinSpecifier;                              //@synthesize showingPinSpecifier=_showingPinSpecifier - In the implementation block
...
-(void)setShowingPinSpecifier:(PSSpecifier *)arg1 ;
-(void)setShowingPinTarget:(id)arg1 ;
-(void)restoreSpecifierTarget;
-(PSSpecifier *)showingPinSpecifier;
-(id)showingPinTarget;
-(id)init;
