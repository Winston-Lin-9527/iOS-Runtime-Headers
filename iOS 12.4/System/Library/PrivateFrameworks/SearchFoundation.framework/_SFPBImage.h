...
@class NSData, _SFPBGraphicalFloat, _SFPBPointSize, NSString, _SFPBURLImage, _SFPBContactImage, _SFPBMonogramImage, _SFPBLocalImage, _SFPBAppIconImage, _SFPBMediaArtworkImage;
