...
@class UIViewController, NSString, UIAlertController, BuddyChoiceController;
...
@property (assign,nonatomic,__weak) BuddyChoiceController * choiceController;              //@synthesize choiceController=_choiceController - In the implementation block
...
-(BuddyChoiceController *)choiceController;
...
-(void)setChoiceController:(BuddyChoiceController *)arg1 ;
