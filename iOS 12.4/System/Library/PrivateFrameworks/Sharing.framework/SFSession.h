...
@class NSObject, NSString, NSMutableData, NSUUID, SFAppleIDContactInfo, CUMessageSessionServer, CUMessageSession, NSDate, NSXPCConnection, SFTRSession, TRSession, SFDevice, CUAppleIDClient, NSDictionary, NSXPCListenerEndpoint, NSMutableDictionary;
