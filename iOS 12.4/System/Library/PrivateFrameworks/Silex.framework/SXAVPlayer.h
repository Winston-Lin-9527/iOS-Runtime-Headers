...
@interface SXAVPlayer : AVPlayer <AVPlayerItemDelegate> {
	...
	SCD_Struct_SX17 _cumulativeTimePlayed;
...
@property (assign,nonatomic) SCD_Struct_SX17 cumulativeTimePlayed;                        //@synthesize cumulativeTimePlayed=_cumulativeTimePlayed - In the implementation block
...
-(SCD_Struct_SX17)cumulativeTimePlayed;
-(void)updateTime:(SCD_Struct_SX17)arg1 duration:(SCD_Struct_SX17)arg2 ;
-(void)setCumulativeTimePlayed:(SCD_Struct_SX17)arg1 ;
