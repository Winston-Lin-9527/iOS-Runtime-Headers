...
@interface SXComponentView : UIView <UIGestureRecognizerDelegate, STTextCanvasRenderSource, SXAXAssistiveTechStatusChangeListener, SXTransitionableComponentView, UIViewControllerPreviewingDelegate, SXComponentInteractable> {
	...
	SCD_Struct_SX15 _presentationChanges;
...
@property (assign,nonatomic) SCD_Struct_SX15 presentationChanges;                                              //@synthesize presentationChanges=_presentationChanges - In the implementation block
...
-(SCD_Struct_SX15)presentationChanges;
-(void)setPresentationChanges:(SCD_Struct_SX15)arg1 ;
