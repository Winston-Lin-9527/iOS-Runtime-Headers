...
@interface SBFColorBoxes : NSObject {
	...
	SCD_Struct_SB10* _colorBoxesRowMajor;
...
@property (nonatomic,readonly) SCD_Struct_SB10* colorBoxesRowMajor;                       //@synthesize colorBoxesRowMajor=_colorBoxesRowMajor - In the implementation block
...
-(id)initWithColorBoxes:(SCD_Struct_SB10*)arg1 size:(unsigned long long)arg2 rowCount:(unsigned long long)arg3 columnCount:(unsigned long long)arg4 totalContrast8:(unsigned char)arg5 imageSize:(CGSize)arg6 downsampledBoxSize:(unsigned long long)arg7 effectiveDownsampleFactor:(unsigned long long)arg8 pixelHeight:(unsigned long long)arg9 pixelWidth:(unsigned long long)arg10 ;
-(void)_freeColorBoxes;
-(CGRect)rectForColorBoxAtRow:(unsigned long long)arg1 col:(unsigned long long)arg2 ;
-(SCD_Struct_SB10*)colorBoxAtRow:(unsigned long long)arg1 col:(unsigned long long)arg2 ;
-(unsigned long long)downsampledBoxSize;
-(unsigned long long)effectiveDownsampleFactor;
-(unsigned char)totalContrast8;
-(SCD_Struct_SB10*)colorBoxesRowMajor;
