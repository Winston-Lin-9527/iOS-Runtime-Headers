...
typedef struct {
	...
	SCD_Struct_TS23 mNumberFormatStruct;
	SCD_Struct_TS24 mFractionFormatStruct;
	SCD_Struct_TS25 mBaseFormatStruct;
	SCD_Struct_TS26 mDateFormatStruct;
	SCD_Struct_TS27 mDurationFormatStruct;
	SCD_Struct_TS30 mCustomFormatStruct;
	SCD_Struct_TS28 mControlFormatStruct;
	SCD_Struct_TS29) mMultipleChoiceListFormatStruct;
} SCD_Struct_TS31;
...
typedef struct {
	...
	SCD_Struct_TS28 field7;
	SCD_Struct_TS30 field8;
	SCD_Struct_TS32 field9;
	SCD_Struct_TS33 field10;
	SCD_Struct_TS34) field11;
} SCD_Struct_TS35;
