...
@class _TVPopoverDescriptor, TVButton, TVImageProxy, NSString;
...
@property (nonatomic,retain) TVButton * tvPopoverButton;                            //@synthesize tvPopoverButton=_tvPopoverButton - In the implementation block
...
-(TVButton *)tvPopoverButton;
-(void)setTvPopoverButton:(TVButton *)arg1 ;
@end
