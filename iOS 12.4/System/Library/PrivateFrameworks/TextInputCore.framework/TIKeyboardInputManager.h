...
@property (nonatomic,retain) NSNumber * isTrackingSentenceCountForPFL;                                       //@synthesize isTrackingSentenceCountForPFL=_isTrackingSentenceCountForPFL - In the implementation block
...
-(NSNumber *)isTrackingSentenceCountForPFL;
-(void)setIsTrackingSentenceCountForPFL:(NSNumber *)arg1 ;
