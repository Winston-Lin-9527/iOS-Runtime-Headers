...
@class TMLRect, NSString, NSOperation, NSMapTable, UITraitCollection, _UIImageVectorImageSupport, UIImageAsset, NSURL, NSArray, CIImage, UIGraphicsImageRendererFormat;

@interface UIImage : NSObject <UIImageJSExports, DOCThumbnail, MKArtworkImageSource, NSItemProviderReading, NSItemProviderWriting, UIItemProviderPresentationSizeProviding, UIItemProviderReading, UIItemProviderWriting, NSSecureCoding> {
