...
@interface UINavigationController : UIViewController <HUPresentationDelegate, HUPreloadableViewController, GKContentRefresh, GKURLHandling, UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate> {
...
-(SCD_Struct_UI28)_calculateTopLayoutInfoForViewController:(id)arg1 ;
