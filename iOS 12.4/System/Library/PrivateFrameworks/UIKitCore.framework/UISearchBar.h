...
@class NSString, NSIndexSet, UIColor, UIImage, UIInputContextHistory, UITextInputPasswordRules, UISearchBarTextField, UILabel, UIButton, UIImageView, NSArray, UIView, _UISearchBarNavigationItem, _UISearchBarScopeBarBackground, UIBarButtonItem, _UIBackdropView, UITapGestureRecognizer, UITextInputTraits, _UINavigationBarTitleViewOverlayRects, UISearchController, UITextField, UITextInputAssistantItem;
