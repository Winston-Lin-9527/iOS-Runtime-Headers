...
@interface UITableView : UIScrollView <UIGestureRecognizerDelegatePrivate, UIScrollViewDelegate, _UITableViewSubviewManagerDelegate, UISwipeActionHost, _UITableViewDragControllerDelegate, _UITableViewDropControllerDelegate, UITable_ForMailOnly, _UIKeyboardAutoRespondingScrollView, UITable_RowDataSource, UITable_UITableViewCellDelegate, _UIDataSourceBackedView, NSCoding, UIDataSourceTranslating> {
	...
	struct {
		...
		unsigned swipeToDeleteShadowUpdatesAreBeingInserted : 1;
...
@property (nonatomic,readonly) id<TSSwipeActionControllerType> ts_swipeActionController; 
...
-(id<TSSwipeActionControllerType>)ts_swipeActionController;
-(id<TSSwipeActionControllerType>)ts_swipeActionController;
...
-(void)swipeActionController:(id)arg1 animateView:(id)arg2 actionsView:(id)arg3 forDestructiveAction:(id)arg4 atIndexPath:(id)arg5 withSwipeInfo:(SCD_Struct_UI96)arg6 completion:(/*^block*/id)arg7 ;
