...
@class _UITextKitTextRange, _UITextInputControllerTokenizer, UITextPasteController, NSLayoutManager, NSHashTable, _UITextServiceSession, UITextInputTraits, NSDictionary, NSArray, UIView, _UITextUndoManager, _UITextUndoOperationTyping, UITextChecker, NSSet, _UIDictationAttachment, NSString, UITextInputPasswordRules, UITextRange, UITextPosition;
