...
@class NSString, NSMutableArray, UITraitCollection, UIViewAnimationInfo, CALayer, UIWindow, NSArray, UIViewController, UIColor, UILayoutGuide, NSISVariable, NSISEngine, NSMapTable, UIStoryboardPreviewingSegueTemplateStorage, UIPresentationController, _UIViewLayoutEngineRelativeAlignmentRectOriginCache, TUGutterView, TMLContext, NSDictionary, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSLayoutDimension, NSNumber, CABasicAnimation, PXViewSpec, UIFont, MKMapView, CNContactStyle, NAUITextStyleDescriptor, MPArtworkCatalog, UIKBRenderConfig, _UITouchForceObservable, UIDropInteraction, _UIBoundingPath, NSMutableSet, UIBezierPath;
...
@property (readonly,nonatomic) TUGutterView * gutterView; 
@property (readonly,nonatomic) CGRect ts_frameUsingCenterAndBounds; 
...
+(void)_sf_animateLinkImage:(id)arg1 withAnimation:(long long)arg2 fromPoint:(CGPoint)arg3 inView:(id)arg4 toRect:(CGRect)arg5 inView:(id)arg6 afterImageDisappearsBlock:(/*^block*/id)arg7 afterDestinationLayerBouncesBlock:(/*^block*/id)arg8 ;
+(void)_sf_animateLinkImage:(CGImageRef)arg1 withAnimation:(long long)arg2 fromRect:(CGRect)arg3 inView:(id)arg4 toRect:(CGRect)arg5 inView:(id)arg6 afterImageDisappearsBlock:(/*^block*/id)arg7 afterDestinationLayerBouncesBlock:(/*^block*/id)arg8 ;
...
-(void)_tmlEnsureContext:(/*^block*/id)arg1 ;
...
-(id)_web_recursiveFindDescendantInteractibleViewAtPoint:(CGPoint)arg1 withEvent:(id)arg2 ;
