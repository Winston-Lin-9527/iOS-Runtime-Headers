...
@class HFItem, UIView, UITabBarItem, UINavigationItem, NSArray, NSString, NSBundle, UIResponder, UIStoryboard, NSDictionary, UIBarButtonItem, UISearchDisplayController, UIPopoverController, UILayoutContainerView, UIScrollView, NSMapTable, NSMutableArray, UITraitCollection, UIAccessibilityHUDView, UITransitionView, UIPresentationController, NSLayoutConstraint, UIStoryboardSegue, UIWindow, UINavigationContentAdjustments, TSTransitionContainerViewController, TMLContext, NSData, FMSlidingPaneViewController, _ADUIViewControllerAdController, PUModalTransition, PUNavigationTransition, PUViewModel, UIToolbar, PUToolbarViewModel, _UIBackdropView, SKUIScrollingSegmentedController, SKUIScrollingTabBarController, SKUIStackedBar, PXOneUpPresentation, PXImageModulationManager, PXExtendedTraitCollection, PXBarAppearance, SUStorePageProtocol, SUViewControllerFactory, _UIActionSheetPresentationController, UIMultiColumnViewController, UITabBarController, UISplitViewController, UINavigationController, NSExtensionContext, UIDropShadowView, NSUUID;

@interface UIViewController : UIResponder <TSPresenterType, TSPresenterType, SXHostable, HUItemPresentationContainer, GKContentRefresh, GKURLHandling, PXAnonymousViewController, PXDiagnosticsEnvironment, MKInfoCardThemeListener, NSExtensionRequestHandling, _UIViewServiceDeputy, UIViewControllerPresenting, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
...
+(void)presentViewControllerOnTopmostViewController:(id)arg1 fromViewController:(id)arg2 completion:(/*^block*/id)arg3 ;
