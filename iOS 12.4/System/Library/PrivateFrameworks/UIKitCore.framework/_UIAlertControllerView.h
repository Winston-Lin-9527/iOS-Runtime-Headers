...
@class UIAlertController, UIAlertControllerVisualStyle, UIView, _UIAlertControllerInterfaceActionGroupView, UILabel, _UIKeyboardLayoutAlignmentView, NSMutableArray, NSArray, NSLayoutConstraint, UIAlertAction, _UIAlertControllerActionViewMetrics, _UIFlexibleConstantConstraintSet, NSString;
