...
@class _UIBannerView, _UIBannerContent, _UIBannerController, NSLayoutConstraint, NSMutableArray, NSString;
...
@property (assign,nonatomic,__weak) _UIBannerController * controller;                   //@synthesize controller=_controller - In the implementation block
...
-(_UIBannerController *)controller;
-(void)setController:(_UIBannerController *)arg1 ;
-(void)present;
