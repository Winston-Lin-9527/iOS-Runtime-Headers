...
@class UIView, UIPreviewInteraction, _UIPreviewInteractionStateRecognizer, CADisplayLink, _UIDeepPressAnalyzer, _UIStatesFeedbackGenerator, _UIPreviewInteractionHighlighter, _UIPreviewInteractionViewControllerHelper, NSString;
