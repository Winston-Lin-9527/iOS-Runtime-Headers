...
@property (assign,nonatomic,__weak) id<_UISFCollectionViewDelegateLayout> fallbackDelegate;              //@synthesize fallbackDelegate=_fallbackDelegate - In the implementation block
-(id)init;
...
-(void)setFallbackDelegate:(id<_UISFCollectionViewDelegateLayout>)arg1 ;
...
-(id<_UISFCollectionViewDelegateLayout>)fallbackDelegate;
