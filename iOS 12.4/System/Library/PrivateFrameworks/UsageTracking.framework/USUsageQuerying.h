...
@protocol _CDUserContext, _DKKnowledgeQuerying_DKKnowledgeSynchronizing;
...
@property (readonly) id<_DKKnowledgeQuerying><_DKKnowledgeSynchronizing> eventStorage;              //@synthesize eventStorage=_eventStorage - In the implementation block
-(id)init;
-(id<_CDUserContext>)context;
-(id)initWithContext:(id)arg1 eventStorage:(id)arg2 ;
-(id<_DKKnowledgeQuerying><_DKKnowledgeSynchronizing>)eventStorage;
-(void)queryUsageDuringInterval:(id)arg1 partitionInterval:(double)arg2 focalOnly:(BOOL)arg3 forceImmediateSync:(BOOL)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(void)_computeUsageWithDisplayBacklitEvents:(id)arg1 applicationUsageEvents:(id)arg2 webUsageEvents:(id)arg3 notificationEvents:(id)arg4 categoryByBundleIdentifier:(id)arg5 categoryByWebDomain:(id)arg6 interval:(id)arg7 partitionInterval:(double)arg8 referenceDate:(id)arg9 completionHandler:(/*^block*/id)arg10 ;
...
-(void)_enumerateCurrentApplicationUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 matchingBundleIdentifiers:(id)arg3 block:(/*^block*/id)arg4 ;
...
-(void)_enumerateCurrentWebUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 matchingWebDomains:(id)arg3 block:(/*^block*/id)arg4 ;
...
-(void)queryUsageDuringInterval:(id)arg1 partitionInterval:(double)arg2 forceImmediateSync:(BOOL)arg3 completionHandler:(/*^block*/id)arg4 ;
