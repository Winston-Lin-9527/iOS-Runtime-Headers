...
@property (nonatomic,retain) NCNotificationListSection * section;              //@synthesize section=_section - In the implementation block
...
-(NCNotificationListSection *)section;
-(void)setSection:(NCNotificationListSection *)arg1 ;
@end
