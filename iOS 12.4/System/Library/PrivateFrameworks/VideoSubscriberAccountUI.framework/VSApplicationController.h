...
@class VSIdentityProvider, VSAuditToken, VSStateMachine, NSError, NSURL, NSOperationQueue, VSApplication, VSApplicationControllerResponseHandler, VSAppDocumentController, JSValue, VSPreferences, NSString;
