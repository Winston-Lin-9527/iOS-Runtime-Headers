...
@class VUIMediaLibrary, NSObject, NSMutableDictionary, VUIMediaEntityKind, NSSet, NSString, VUIMediaEntityType, NSNumber, NSDate, VUIContentRating;
...
@property (nonatomic,copy,readonly) VUIContentRating * contentRating; 
