...
@class NSArray, UIView, UILabel, UIButton, SUICFlamesView, CSVTUITrainingManager, AFUISiriLanguage, NSObject, SiriUIContentButton, VTUIEnrollmentSuccessView, VTUIEnrollmentSetupIntroView, VTUITickMarkView, NSString, VTUIEnrollmentLanguageOptionsView, AFMyriadCoordinator, VTUIPagedLabel, VTUIAudioHintPlayer;

@interface VTUIEnrollTrainingViewController : UIViewController <CSVTUITrainingManagerDelegate, SUICFlamesViewDelegate, VTUIEnrollmentSetupIntroViewDelegate, AFUIDebugControllerDelegate, AFUISiriLanguageDelegate, AFMyriadDelegate> {
