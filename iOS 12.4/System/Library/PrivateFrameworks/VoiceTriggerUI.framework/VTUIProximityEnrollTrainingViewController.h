...
@class NSArray, CSVTUITrainingManager, AFUISiriLanguage, NSObject, VTUIProximityEnrollTrainingView, VTUIProximityEnrollmentSuccessView, VTUIProximityEnrollmentSetupIntroView, VTUIProximityTryAgainView, NSString, VTUIProximityEnrollmentLanguageOptionsView, UIView, AFMyriadCoordinator, VTUIAudioHintPlayer;

@interface VTUIProximityEnrollTrainingViewController : UIViewController <CSVTUITrainingManagerDelegate, VTUIEnrollmentSetupIntroViewDelegate, SUICFlamesViewDelegate, AFUIDebugControllerDelegate, AFUISiriLanguageDelegate, AFMyriadDelegate> {
