...
@class UIAlertView, YTCategoriesRequest, NSArray, NSURL, NSString, UITableView, UIView, CategoryCell, NSMutableArray, PLTableViewEditableCell, UITableViewCell, UIPickerView, PublishContainerView, PublishFooterTextView, UIButton, ACAccountStore, SLGoogleAuthController;
...
@interface PublishToYouTubeViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, YTAuthenticatorDelegate> {
	...
	SLGoogleAuthController* _googleAuthController;
