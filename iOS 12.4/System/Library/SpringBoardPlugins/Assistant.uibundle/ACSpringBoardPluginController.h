...
-(void)_handleNewRemoteRequestWithInfo:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(BOOL)handleActivationEvent:(int)arg1 eventSource:(int)arg2 context:(void*)arg3 completion:(/*^block*/id)arg4 ;
-(BOOL)_carDNDActive;
...
-(void)_startRequestWithOptions:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_updateExpectsFaceContact;
-(void)_handleSyntheticActivationEvent:(int)arg1 source:(int)arg2 context:(void*)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)_openURL:(id)arg1 withBundleIdentifier:(id)arg2 delaySessionEndForTTS:(BOOL)arg3 replyHandler:(/*^block*/id)arg4 ;
...
-(void)_handleRequestWatcherVoiceTriggerRequestWithInfo:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_activateFromVoiceTriggerWithSource:(int)arg1 info:(id)arg2 completion:(/*^block*/id)arg3 ;
