...
-(id)initWithWordSearch:(id)arg1 inputString:(id)arg2 contextString:(id)arg3 predictionEnabled:(BOOL)arg4 reanalysisMode:(BOOL)arg5 autocapitalizationType:(unsigned long long)arg6 target:(id)arg7 action:(SEL)arg8 geometryModelData:(id)arg9 flickUsed:(BOOL)arg10 phraseBoundarySet:(BOOL)arg11 hardwareKeyboardMode:(BOOL)arg12 logger:(id)arg13 ;
