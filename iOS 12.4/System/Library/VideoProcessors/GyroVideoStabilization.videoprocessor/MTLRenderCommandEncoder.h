...
-(void)setViewports:(const SCD_Struct_CM10*)arg1 count:(unsigned long long)arg2;
...
-(void)setScissorRect:(SCD_Struct_CM11)arg1;
-(void)setScissorRects:(const SCD_Struct_CM11*)arg1 count:(unsigned long long)arg2;
...
-(void)dispatchThreadsPerTile:(SCD_Struct_CM9)arg1;
...
-(void)setViewport:(SCD_Struct_CM10)arg1;
