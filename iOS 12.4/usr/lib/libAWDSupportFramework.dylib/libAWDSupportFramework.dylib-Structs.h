...
typedef struct {
	unsigned beganTimestamp : 1;
	unsigned endedTimestamp : 1;
	unsigned enteredKnownNetworkGeotagLocationTimeStamp : 1;
	unsigned timestamp : 1;
	unsigned wakeTimestamp : 1;
	unsigned bandScanCount24 : 1;
	unsigned bandScanCount5 : 1;
	unsigned ccaBitmap : 1;
	unsigned knownNetworksFoundInScans : 1;
	unsigned lastScanError : 1;
	unsigned lastScanType : 1;
	unsigned resetReason : 1;
	unsigned resetTypes : 1;
	unsigned retryIndex : 1;
	unsigned rssiBitmap : 1;
	unsigned scanResultFound : 1;
	unsigned scanTypes : 1;
	unsigned state : 1;
} SCD_Struct_AW38;
