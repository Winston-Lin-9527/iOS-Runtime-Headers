...
@protocol OS_nw_endpoint, OS_nw_parameters, OS_nw_endpoint_handler, OS_nw_array, OS_nw_write_request, OS_nw_read_request, OS_dispatch_queue;
...
@interface NWConcrete_nw_connection : NSObject <OS_nw_connection> {
	...
	unsigned prohibit_set_queue : 1;
	unsigned batching : 1;
	unsigned has_batched_sends : 1;
	unsigned has_batched_receives : 1;
