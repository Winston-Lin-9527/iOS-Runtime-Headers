...
@class AccessoryNowPlayingClient, NSObject, ACCSettingsState, NSMutableDictionary, NSData, ACCMemUsageStat, NSString;
...
@interface ACCNowPlayingFeaturePlugin : NSObject <AccessoryNowPlayingClientProtocol, ACCFeaturePluginProtocol> {
	...
	ACCSettingsState* _maxMediaRemoteCountOverride;
...
@property (nonatomic,retain) ACCSettingsState * maxMediaRemoteCountOverride;                         //@synthesize maxMediaRemoteCountOverride=_maxMediaRemoteCountOverride - In the implementation block
...
-(void)setMaxMediaRemoteCountOverride:(ACCSettingsState *)arg1 ;
...
-(void)_setupMediaRemoteDefaultQueueAccessSize;
...
-(ACCSettingsState *)maxMediaRemoteCountOverride;
