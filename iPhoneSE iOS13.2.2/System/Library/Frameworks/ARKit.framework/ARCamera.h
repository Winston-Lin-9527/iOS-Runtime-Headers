...
@property (assign,nonatomic) SCD_Struct_AR28 intrinsics;                      //@synthesize intrinsics=_intrinsics - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_AR12 projectionMatrix; 
...
-(SCD_Struct_AR12)projectionMatrixForOrientation:(long long)arg1 viewportSize:(CGSize)arg2 zNear:(double)arg3 zFar:(double)arg4 ;
-(SCD_Struct_AR12)viewMatrixForOrientation:(long long)arg1 ;
-(id)initWithIntrinsics:(SCD_Struct_AR28)arg1 imageResolution:(CGSize)arg2 ;
-(SCD_Struct_AR12)displayCenterTransform;
-(CGPoint)projectPoint:(long long)arg1 orientation:(CGSize)arg2 ;
-(1)unprojectPoint:(CGPoint)arg1 ontoPlaneWithTransform:(SCD_Struct_AR12)arg2 orientation:(long long)arg3 viewportSize:(CGSize)arg4 ;
-(void)setTrackingStateReason:(long long)arg1 ;
-(SCD_Struct_AR28)intrinsics;
-(void)setIntrinsics:(SCD_Struct_AR28)arg1 ;
@end
