...
@interface ARCubemapCompletion : NSObject {
	...
	void* _espresso_ctx;
	void* _espresso_plan;
	SCD_Struct_AR103* _espresso_net;
	SCD_Struct_AR104 _espresso_processing_params;
...
-(id)completeCubemap:(id)arg1 cameraExposure:(double)arg2 rotationWorldFromCube:(SCD_Struct_AR28)arg3 ;
...
-(id)toTexture:(SCD_Struct_AR19*)arg1 ;
