...
@interface ARFaceTrackingData : NSObject <NSSecureCoding, NSCopying> {
	...
	NSError* _trackingError;
	 _gazePoint;
	SCD_Struct_AR12 _leftEyeTransform;
	SCD_Struct_AR12 _rightEyeTransform;
...
@property (nonatomic,readonly) SCD_Struct_AR12 leftEyeTransform;                            //@synthesize leftEyeTransform=_leftEyeTransform - In the implementation block
@property (nonatomic,readonly) SCD_Struct_AR12 rightEyeTransform;                           //@synthesize rightEyeTransform=_rightEyeTransform - In the implementation block
...
-(const *)normals;
-(const *)imageVertices;
-(SCD_Struct_AR12)leftEyeTransform;
-(SCD_Struct_AR12)rightEyeTransform;
-()gazePoint;
