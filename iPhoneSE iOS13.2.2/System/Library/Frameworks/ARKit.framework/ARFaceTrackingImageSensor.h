...
-(id)prepareToStart;
-(void)capturedSynchedOutput:(id)arg1 didOutputSampleBuffer:(opaqueCMSampleBufferRef)arg2 fromVideoConnection:(id)arg3 metaDataOutput:(id)arg4 didOutputMetadataObjects:(id)arg5 didOutputDepthData:(id)arg6 atTime:(SCD_Struct_AR32)arg7 ;
-(BOOL)recordingMode;
