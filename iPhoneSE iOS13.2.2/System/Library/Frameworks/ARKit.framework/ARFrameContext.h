...
@interface ARFrameContext : NSObject <ARResultDataContext> {
	...
	SCD_Struct_AR12 _relocalizationDeltaTransform;
	SCD_Struct_AR12 _sessionTransform;

}

@property (assign,nonatomic) BOOL didRelocalize;                                             //@synthesize didRelocalize=_didRelocalize - In the implementation block
@property (assign,nonatomic) SCD_Struct_AR12 relocalizationDeltaTransform;                   //@synthesize relocalizationDeltaTransform=_relocalizationDeltaTransform - In the implementation block
@property (assign,nonatomic) SCD_Struct_AR12 sessionTransform;                               //@synthesize sessionTransform=_sessionTransform - In the implementation block
...
-(id)anchorsToRemove;
-(void)setSessionTransform:(SCD_Struct_AR12)arg1 ;
...
-(SCD_Struct_AR12)relocalizationDeltaTransform;
-(void)setRelocalizationDeltaTransform:(SCD_Struct_AR12)arg1 ;
-(SCD_Struct_AR12)sessionTransform;
