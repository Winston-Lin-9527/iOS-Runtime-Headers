...
-(id)_updatedAnchor:(id)arg1 forPlane:(CV3DSurfaceDetectionPlane*)arg2 referenceOriginTransform:(SCD_Struct_AR12)arg3 ;
-(id)_anchorForPlane:(CV3DSurfaceDetectionPlane*)arg1 identifier:(id)arg2 referenceOriginTransform:(SCD_Struct_AR12)arg3 ;
-(float)_surfaceOrientedPivotForPlane:(CV3DSurfaceDetectionPlane*)arg1 ;
-(SCD_Struct_AR12)_planeToWorldTransformForPlane:(CV3DSurfaceDetectionPlane*)arg1 pivot:(float)arg2 ;
-(long long)_worldAlignmentRotationForReferenceTransform:(SCD_Struct_AR12)arg1 planeAlignment:(long long)arg2 ;
...
-(id)hitTestFromOrigin:(SCD_Struct_AR12)arg1 withDirection:(long long)arg2 ;
@end
