...
+(id)_detectPlanesWithDetector:(CV3DSurfaceDetectionContextRef)arg1 types:(unsigned long long)arg2 camera:(id)arg3 referenceFeaturePoints:(id)arg4 referenceOriginTransform:(SCD_Struct_AR12)arg5 ;
-(void)dealloc;
