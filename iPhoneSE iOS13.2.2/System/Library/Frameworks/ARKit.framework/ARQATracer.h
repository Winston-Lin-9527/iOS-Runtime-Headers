...
@class NSMutableDictionary, NSMutableData, NSOutputStream, NSObject, MOVWriterInterface, NSDictionary, NSArray, NSString, UILabel, ARScreenRecording, ARPresentationStats;
...
@property (nonatomic,retain) ARPresentationStats * presentationStats;              //@synthesize presentationStats=_presentationStats - In the implementation block
...
-(BOOL)forceQuitApp;
-(ARPresentationStats *)presentationStats;
...
-(void)setPresentationStats:(ARPresentationStats *)arg1 ;
@end
