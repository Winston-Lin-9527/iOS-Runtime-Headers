...
@class NSURL, NSSet, NSObject, MOVWriterInterface, NSMutableDictionary, NSError, ARParentImageSensorSettings, NSString;
...
-(BOOL)allowedToWrite;
-(void)writeDepthMap:(id)arg1 withTimestamp:(SCD_Struct_AR32)arg2 ;
