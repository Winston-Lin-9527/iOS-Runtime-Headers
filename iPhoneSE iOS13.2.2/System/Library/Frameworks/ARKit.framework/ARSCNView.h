...
#import <ARKit/ARPresentationDelegate.h>
#import <ARKit/ARSessionProviding.h>

@protocol SCNCaptureDeviceOutputConsumer, OS_dispatch_semaphore;
@class ARSession, SCNNode, NSMutableDictionary, NSObject, NSMutableArray, ARPointCloud, UIView, CIWarpKernel, ARSCNCompositor, ARPresentation, ARPresentationFrame, ARSinglePassRenderer, ARFrame, SCNScene, NSString;
...
@interface ARSCNView : SCNView <ARInternalSessionObserver, _SCNSceneRendererDelegate, ARPresentationDelegate, ARSessionProviding> {
	...
	SCD_Struct_AR12 _currentReferenceTransform;
...
-(9)unprojectPoint:(CGPoint)arg1 ontoPlaneWithTransform:(SCD_Struct_AR12)arg2 ;
