...
#import <ARKit/ARPresentationInternalObserver.h>

@protocol OS_dispatch_semaphore, OS_dispatch_queue, ARSessionDelegate;
@class ARTechnique, ARWorldTrackingTechnique, AREnvironmentTexturingTechnique, ARRecordingTechniquePublic, NSObject, ARFrame, ARFrameContext, NSHashTable, CMMotionManager, ARSessionMetrics, NSDate, ARRenderSyncScheduler, ARImageSensor, ARLocationSensor, ARProximitySensor, NSArray, ARDevicePerformanceMonitor, ARDevicePerformanceLevel, ARPresentationThermalPolicy, ARPresentationThermalPolicyManager, ARTrackedRaycastPostProcessor, ARBKSAccelerometer, ARVideoFormat, ARParentTechnique, NSUUID, ARConfiguration, ARQATracer, ARDeviceOrientationData, ARLocationData, ARPresentation, NSString;
...
@interface ARSession : NSObject <ARSensorDelegate, ARTechniqueDelegate, ARWorldTrackingTechniqueObserver, ARDevicePerformanceMonitorDelegate, ARPresentationInternalObserver> {
	...
	SCD_Struct_AR12 _lastPredictedFrameTransform;
	...
	SCD_Struct_AR12 _cyclopToCameraTransform;
...
@property (nonatomic,readonly) ARPresentation * presentation;                          //@synthesize presentation=_presentation - In the implementation block
@property (assign,nonatomic) SCD_Struct_AR12 cyclopToCameraTransform; 
...
-(SCD_Struct_AR12)predictedDeviceTransformAtTimestamp:(double)arg1 ;
...
-(SCD_Struct_AR12)predictedAppPointTransformAtTimestamp:(double)arg1 ;
...
-(id)_getObservers;
-(SCD_Struct_AR12)_cameraTransformForResultData:(id)arg1 previousFrame:(id)arg2 ;
...
-(void)setWorldOrigin:(SCD_Struct_AR12)arg1 ;
-(void)forceEnvironmentTexturingToManualMode:(BOOL)arg1 ;
-(void)getCurrentWorldMapWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)createReferenceObjectWithTransform:(SCD_Struct_AR12)arg1 center:(/*^block*/id)arg2 ;
-(SCD_Struct_AR12)originTransform;
-(void)setOriginTransform:(SCD_Struct_AR12)arg1 ;
-(SCD_Struct_AR12)cyclopToCameraTransform;
-(void)setCyclopToCameraTransform:(SCD_Struct_AR12)arg1 ;
