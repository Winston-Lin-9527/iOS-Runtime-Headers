...
@property (nonatomic,readonly) SCD_Struct_AR12 referenceOriginTransform;              //@synthesize referenceOriginTransform=_referenceOriginTransform - In the implementation block
...
+(id)featurePointsForTrackingData:(id)arg1 referenceOriginTransform:(SCD_Struct_AR12)arg2 ;
...
+(id)keyframesForTrackingData:(id)arg1 withFeaturePoints:(id)arg2 referenceOriginTransform:(SCD_Struct_AR12)arg3 ;
...
-(id)initWithTrackingData:(id)arg1 referenceOriginTransform:(SCD_Struct_AR12)arg2 featurePoints:(id)arg3 bounds:(compressed_pair<float * __attribute__((ext_vector_type(2))), std::__1::allocator<float __attribute__((ext_vector_type(2)))> >)arg4 ;
-(id)initWithTrackingData:(id)arg1 referenceOriginTransform:(SCD_Struct_AR12)arg2 ;
-(NSData *)surfaceData;
-(id)extractReferenceObjectWithTransform:(SCD_Struct_AR12)arg1 center:(id*)arg2 ;
