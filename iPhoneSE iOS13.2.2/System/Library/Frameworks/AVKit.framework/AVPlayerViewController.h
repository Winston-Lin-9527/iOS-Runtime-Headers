...
@class UIWindow, NSDictionary, AVSecondScreenConnection, AVPictureInPictureController, UIPopoverPresentationController, AVTransitionController, AVPlaybackControlsVisibilityController, AVPlaybackControlsController, AVPlayerView, NSValue, AVPlayer, NSMutableDictionary, AVPlayerController, AVContentOverlayView, NSNumber, AVObservationController, AVBehaviorStorage, UIGestureRecognizer, AVPlayerControllerVolumeAnimator, __AVPlayerLayerView, NSString, NSArray, UIView, UIViewController, AVPlayerViewControllerContentView, AVPresentationContext, AVFullScreenViewController, AVPlayerViewControllerCustomControlsView;
...
@property (nonatomic,retain) UIGestureRecognizer * hoverGestureRecognizer;                                                                                                       //@synthesize hoverGestureRecognizer=_hoverGestureRecognizer - In the implementation block
...
-(void)setHoverGestureRecognizer:(UIGestureRecognizer *)arg1 ;
