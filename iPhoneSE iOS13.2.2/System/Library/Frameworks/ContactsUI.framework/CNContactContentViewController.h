...
@property (nonatomic,retain) CNContainer * containerOfContact;                                                //@synthesize containerOfContact=_containerOfContact - In the implementation block
...
@property (assign,nonatomic) BOOL saveWasAuthorized;                                                          //@synthesize saveWasAuthorized=_saveWasAuthorized - In the implementation block
...
-(CNContainer *)containerOfContact;
-(void)setContainerOfContact:(CNContainer *)arg1 ;
