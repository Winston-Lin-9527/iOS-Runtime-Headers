...
@class UITableView, UISearchController, UISearchBar, NSIndexPath, CNContactContentViewController, CNContactFormatter, CNUIFamilyMemberDowntimeContactDataSource, CNUIFamilyMemberContactsEditingStrategy, FAFamilyMember, NSArray, CNContact, CNUICoreContactEditingSession, NSString;
...
@property (nonatomic,retain) CNContactContentViewController * contactViewController;                                   //@synthesize contactViewController=_contactViewController - In the implementation block
...
-(void)setContactViewController:(CNContactContentViewController *)arg1 ;
