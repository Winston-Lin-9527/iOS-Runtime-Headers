...
@class WKWebView, NSURL, NSTimer, NSObject, LPLinkMetadata, LPFetcherGroup, LPAnimatedImageTranscoder, NSMutableArray, LPMetadataProviderSpecialization, NSString;
