...
@class UIScrollView, UIView, MFMailComposeToField, MFMailComposeRecipientTextView, MFComposeSubjectView, MFComposeFromView, MFComposeMultiView, MFComposeImageSizeView, UIPickerView, MFFromAddressViewController, NSMutableArray, UIResponder, NSInvocation, MFMailComposeContactsSearchController, CNAutocompleteResultsTableViewController, UIViewController, MFComposeDisplayMetrics, NSString;
