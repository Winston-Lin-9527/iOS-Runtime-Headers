...
@class NSString, NSArray, MFMailMessage, EMMessage, MFMessageLoadingContext, MFAttachmentCompositionContext, MFAttachmentComposeManager, NSMutableArray, UIView, MFAttachmentManager;
...
@property (nonatomic,retain) NSString * contentVariationAttachmentCID;                          //@synthesize contentVariationAttachmentCID=_contentVariationAttachmentCID - In the implementation block
