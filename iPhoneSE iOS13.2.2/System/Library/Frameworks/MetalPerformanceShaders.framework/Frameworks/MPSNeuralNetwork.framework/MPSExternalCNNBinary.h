...
@optional
-(unsigned long long)encodeBatchToCommandBuffer:(id)arg1 computeCommandEncoder:(id)arg2 options:(unsigned long long)arg3 pluginOptions:(unsigned long long)arg4 primaryTextures:(id)arg5 primaryInfo:(const SCD_Struct_MP15*)arg6 secondaryTextures:(id)arg7 secondaryInfo:(const SCD_Struct_MP15*)arg8 destinationTextures:(id)arg9 destinationInfo:(const SCD_Struct_MP16*)arg10 predicationBuffer:(id)arg11 predicationOffset:(unsigned long long)arg12;
...
-(unsigned long long)encodeWithFilter:(id)arg1 encoder:(id)arg2 commandBuffer:(id)arg3 callInfo:(const SCD_Struct_MP21*)arg4 ;
