...
+(NSMutableData*)createHMACFromData:(id)arg1 key:(id)arg2 prfAlgorithm:(unsigned long long)arg3 ;
...
+(NSMutableData*)createHMACFromData:(id)arg1 key:(id)arg2 integrityAlgorithm:(unsigned long long)arg3 ;
+(NSMutableData*)createPRFPlusFromData:(id)arg1 key:(id)arg2 prfAlgorithm:(unsigned long long)arg3 outputLength:(unsigned)arg4 ;
...
+(SecIdentityRef)copySecIdentity:(NSMutableData*)arg1 ;
@end
