...
-(NSMutableData*)createSharedSecretForECPKey:(ccec_full_ctx*)arg1 curveKey:(unsigned char*)arg2 remotePublicKey:(id)arg3 publicKeySize:(unsigned long long)arg4 dhContext:(OpaqueSecDHContextRef)arg5 ;
