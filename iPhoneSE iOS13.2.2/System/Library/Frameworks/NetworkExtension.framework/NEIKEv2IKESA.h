...
@class NEIKEv2IKESPI, NSError, NWAddressEndpoint, NEIKEv2IKESAConfiguration, NEIKEv2SessionConfiguration, NEIKEv2IKESAProposal, NSData, NEIKEv2DHProtocol, NSString, NEIKEv2Identifier, NSArray, NEIKEv2AuthenticationProtocol, NEIKEv2ConfigurationMessage, NEIKEv2EAP, NEIKEv2Transport, NSObject, NSMutableData;
...
+(NSMutableData*)createAuthenticationDataForSharedSecret:(id)arg1 octets:(id)arg2 prfProtocol:(id)arg3 ;
+(BOOL)checkValidityOfDigitalSignature:(id)arg1 authenticationProtocol:(id)arg2 sessionConfiguration:(id)arg3 remoteSignedOctets:(NSMutableData*)arg4 ;
+(NSMutableData*)copySharedSecretFromConfig:(id)arg1 ;
+(BOOL)checkValidityOfDigitalSignature:(id)arg1 sessionConfiguration:(id)arg2 remoteSignedOctets:(NSMutableData*)arg3 ;
-(void)dealloc;
-(id)description;
...
-(NSMutableData*)createResponderSignedOctets;
-(NSMutableData*)createInitiatorSignedOctets;
-(NSMutableData*)createRemoteSignedOctets;
-(NSMutableData*)createAuthenticationDataForSharedSecret:(id)arg1 octets:(id)arg2 ;
