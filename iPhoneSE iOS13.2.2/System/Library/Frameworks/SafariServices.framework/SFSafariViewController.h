...
@class SFBrowserRemoteViewController, _UIAsyncInvocation, NSArray, _WKActivatedElementInfo, NSMutableDictionary, SFInteractiveDismissController, SFSafariLaunchPlaceholderView, SFSafariViewControllerConfiguration, _SFURLTextPreviewViewController, UIView, UIColor, SFQueueingServiceViewControllerProxy, NSURL, NSString;
