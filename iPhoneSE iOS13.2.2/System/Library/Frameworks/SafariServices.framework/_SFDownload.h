...
@class _WKDownload, WBSFluidProgressState, NSTimer, WKWebView, NSData, SFDownloadFile, NSString, NSURLRequest, NSURL, _WKUserInitiatedAction, NSURLResponse, _SFQuickLookDocument, NSUUID, NSDate, WBSFluidProgressController, NSDictionary;
