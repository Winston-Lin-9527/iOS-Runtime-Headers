...
#import <libobjc.A.dylib/WBUPrintPageRendererDelegate.h>

@protocol _SFDialogPresenting, _SFPrintControllerDelegate;
@class UIPrintInfo, WBUPrintPageRenderer, UIPrintInteractionController, NSString, NSMutableArray, SFPrintQueueItem, WKWebView, _SFReaderController;
