...
@interface SCNCameraNavigationController : NSObject <SCNEventHandler, SCNCameraControllerDelegate> {
	...
	BOOL _mouseDown;
	SCD_Union_SC136 _sceneBoundingSphere;
	 _translationOrigin;
	float _initialZoom;
	...
	SCD_Struct_SC137 _stickyAxis;
	SCD_Struct_SC138 _target;
	SCD_Struct_SC139 _inertia;
	SCD_Struct_SC147* _keyboard;
	SCD_Struct_SC138 _scrollWheelModifiers;
