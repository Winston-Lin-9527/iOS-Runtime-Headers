...
@interface SCNMTLRenderContext : NSObject <SCNBufferStream> {
	...
	SCD_Struct_SC79 _counters;
	SCD_Struct_SC80* _renderGraph;
...
-(void)beginRenderPass:(id)arg1 renderEncoder:(void*)arg2 parameters:(SCD_Struct_SC49)arg3 ;
-(void)endRenderPass;
...
-(void)startProcessingRendererElementsWithEngineIterationContext:(SCD_Struct_SC82*)arg1 ;
...
-(void)drawWireframeOverlayForElements:(SCD_Struct_SC83*)arg1 range:(SCD_Struct_SC84)arg2 store:(C3DRendererElementStoreRef)arg3 passInstance:(_C3DFXPassInstance*)arg4 ;
...
-(void)processRendererElements:(SCD_Struct_SC83*)arg1 count:(unsigned)arg2 engineIterationContext:(SCD_Struct_SC82*)arg3 ;
