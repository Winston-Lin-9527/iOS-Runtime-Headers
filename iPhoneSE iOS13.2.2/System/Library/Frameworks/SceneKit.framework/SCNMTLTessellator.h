...
@interface SCNMTLTessellator : NSObject {
	...
	SCD_Struct_SC162 _cachedTessellator;
	id<MTLBuffer> _tessellationFactorBuffer;

}
-(void)dealloc;
-(void)update:(SCD_Struct_SC163*)arg1 ;
...
-(void)draw:(SCD_Struct_SC164*)arg1 ;
-(SCD_Struct_SC165)_pipelineStateHashForMeshElement:(id)arg1 patchType:(unsigned char)arg2 ;
-(void)updateUniformTessellator:(SCD_Struct_SC166)arg1 ;
-(void)updateScreenSpaceAdaptiveTessellator:(SCD_Struct_SC166)arg1 parameters:(SCD_Struct_SC163*)arg2 ;
-(void)updateConstrainedEdgeLengthTessellator:(SCD_Struct_SC166)arg1 withMesh:(id)arg2 computeCommandEncoder:(id)arg3 ;
-(void)updateSubdivisionSurfaceTessellator:(SCD_Struct_SC166)arg1 parameters:(SCD_Struct_SC163*)arg2 ;
...
-(void)subdivisionSurfaceTessellationDraw:(SCD_Struct_SC164*)arg1 ;
@end
