...
typedef struct Vector<WebKit::ItemAndPreview, 0, WTF::CrashOnOverflow, 16> {
	ItemAndPreview m_buffer;
	unsigned m_capacity;
	unsigned m_size;
} Vector<WebKit::ItemAndPreview, 0, WTF::CrashOnOverflow, 16>;

typedef struct Vector<WebKit::ItemAndPreviewProvider, 0, WTF::CrashOnOverflow, 16> {
	ItemAndPreviewProvider m_buffer;
	unsigned m_capacity;
	unsigned m_size;
} Vector<WebKit::ItemAndPreviewProvider, 0, WTF::CrashOnOverflow, 16>;
...
typedef struct DragDropInteractionState {
	...
	Vector<WebKit::ItemAndPreviewProvider, 0, WTF::CrashOnOverflow, 16> m_delayedItemPreviewProviders;
	Vector<WebKit::ItemAndPreview, 0, WTF::CrashOnOverflow, 16> m_defaultDropPreviews;
