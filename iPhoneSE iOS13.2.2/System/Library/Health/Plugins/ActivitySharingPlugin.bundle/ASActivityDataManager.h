...
-(id)_activitySnapshotsToPushWithYesterdaySnapshot:(HKFitnessFriendActivitySnapshot*)arg1 todaySnapshot:(HKFitnessFriendActivitySnapshot*)arg2 ;
-(id)_achievementsToPushWithYesterdaySnapshot:(HKFitnessFriendActivitySnapshot*)arg1 todaySnapshot:(HKFitnessFriendActivitySnapshot*)arg2 currentTodayAchievementAnchorToken:(id)arg3 currentYesterdayAchievementAnchorToken:(id)arg4 ;
-(id)_workoutsToPushWithYesterdaySnapshot:(HKFitnessFriendActivitySnapshot*)arg1 todaySnapshot:(HKFitnessFriendActivitySnapshot*)arg2 currentWorkoutAnchor:(id)arg3 ;
-(id)notificationEventsToPushWithYesterdaySnapshot:(HKFitnessFriendActivitySnapshot*)arg1 todaySnapshot:(HKFitnessFriendActivitySnapshot*)arg2 achievements:(id)arg3 workouts:(id)arg4 currentDeletedWorkoutAnchor:(id)arg5 currentGoalCompletionAnchor:(id)arg6 ;
