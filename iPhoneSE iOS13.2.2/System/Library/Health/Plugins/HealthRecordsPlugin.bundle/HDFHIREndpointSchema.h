...
-(id)createRequestWithCredential:(id)arg1 bindings:(NSDictionary*)arg2 queryMode:(long long)arg3 error:(out id*)arg4 ;
...
-(id)_createRequestWithCredential:(id)arg1 bindings:(NSDictionary*)arg2 orFullURL:(id)arg3 queryMode:(long long)arg4 error:(out id*)arg5 ;
