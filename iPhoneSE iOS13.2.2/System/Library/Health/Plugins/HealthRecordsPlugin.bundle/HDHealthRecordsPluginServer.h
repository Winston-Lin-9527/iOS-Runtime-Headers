...
@interface HDHealthRecordsPluginServer : NSObject <HDDiagnosticObject, HDHealthRecordsPluginServerInterface, HDClinicalIngestionStateChangeObserver, HDClinicalAccountStateObserver, _HKXPCExportable> {
...
-(void)remote_createStaticAccountWithTitle:(id)arg1 subtitle:(id)arg2 description:(id)arg3 onlyIfNeededForSimulatedGatewayID:(id)arg4 completion:(/*^block*/id)arg5 ;
