...
@protocol NSObject;
@class NSString, NSMutableArray, UISearchController, UIBarButtonItem, _SFPasswordIconController, NSCountedSet, _SFSiteMetadataManager, SFSharablePassword, _UIContentUnavailableView, NSDictionary, WBSAutoFillQuirksManager, WBSSavedPasswordAuditor, WBSPasswordEvaluator;
