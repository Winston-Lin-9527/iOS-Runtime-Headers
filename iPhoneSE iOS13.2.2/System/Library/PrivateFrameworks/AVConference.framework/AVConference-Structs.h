...
typedef struct VCMediaStreamTransportSetupInfo {
	...
	/*function pointer*/void* ;
	SCD_Struct_VC126 socketInfo;
	SCD_Struct_VC128 ipInfo;
	SCD_Struct_VC127) nwInfo;
	unsigned sourceRate;
...
typedef struct tagWRMMetricsInfo {
	...
	SCD_Struct_VC150 wrmMetricsReportingContext;
