...
@interface VCMediaControlInfoFaceTimeAudio : VCMediaControlInfo {
	...
	SCD_Struct_VC165 _controlFeedbackParameter;
	BOOL _videoEnabled;
...
-(int)setInfoUnserialized:(SCD_Struct_VC165*)arg1 type:(unsigned)arg2 ;
...
-(int)getInfoUnserialized:(SCD_Struct_VC165*)arg1 type:(unsigned)arg2 ;
