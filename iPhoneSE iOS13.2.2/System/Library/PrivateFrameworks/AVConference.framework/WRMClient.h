...
@interface WRMClient : NSObject {
	...
	int _mode;
	SCD_Struct_WR132 _metricsConfig;
...
-(void)reportMetricsFaceTimeCalling:(const SCD_Struct_VC112*)arg1 ;
-(void)sendStatusUpdateFaceTimeCalling:(const SCD_Struct_VC95*)arg1 ;
-(void)requestNotificationFaceTimeCalling;
-(void)startWRMClientWithMode:(int)arg1 metricsConfig:(SCD_Struct_WR132)arg2 ;
-(void)stopWRMClient;
...
-(void)reportMetricsWifiCalling:(const SCD_Struct_VC112*)arg1 ;
@end
