...
-(id)initWithSize:(CGSize)arg1 scale:(SCNVector3)arg2 position:(SCNVector3)arg3 renderLast:(BOOL)arg4 orientToCamera:(BOOL)arg5 rotation:(SCNVector3)arg6 palettesDescriptions:(id)arg7 shaderModifiers:(id)arg8 ;
