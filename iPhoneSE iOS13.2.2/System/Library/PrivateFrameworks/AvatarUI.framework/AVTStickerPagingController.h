...
@class NSObject, AVTAvatarRecordDataSource, AVTUIStickerGeneratorPool, AVTUIEnvironment, NSMutableDictionary, _AVTAvatarRecordImageProvider, NSArray, UIView, UICollectionView, NSIndexPath, NSString;
