...
@interface BWDepthConverterNode : BWNode {
	...
	SCD_Struct_BW68 _infraredCameraExtrinsicMatrix;
	int _depthAccuracy;
	SCD_Struct_BW69 _depthLensDistortionCorrectionBasePolynomial;
	SCD_Struct_BW69 _depthLensDistortionCorrectionDynamicPolynomial;
