...
-(void)dispatchThreadsPerTile:(SCD_Struct_CM43)arg1;
...
-(void)setViewport:(SCD_Struct_CM44)arg1;
...
-(void)setScissorRect:(SCD_Struct_CM45)arg1;
...
-(void)setViewports:(const SCD_Struct_CM44*)arg1 count:(unsigned long long)arg2;
-(void)setVertexAmplificationCount:(unsigned long long)arg1 viewMappings:(const SCD_Struct_CM46*)arg2;
-(void)setDepthClipMode:(unsigned long long)arg1;
-(void)setScissorRects:(const SCD_Struct_CM45*)arg1 count:(unsigned long long)arg2;
