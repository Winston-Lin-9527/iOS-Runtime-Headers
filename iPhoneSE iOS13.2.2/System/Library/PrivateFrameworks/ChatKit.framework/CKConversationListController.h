...
@class NSIndexPath, CKConversationList, CKMessagesController, CKCloudKitSyncProgressViewController, NSMapTable, CKNavigationBarTitleView, CKLargeTitleAccessoryView, CKScheduledUpdater, UIView, NSArray, CKConversation, UISearchController, CNContact, CKConversationSearchResultsController, CKSearchViewController, _UIContextMenuInteraction, UIBarButtonItem, UIButton, CNContactStore, CKConversationListFilterCell, INKContentController, INKContentView, CKOnboardingController, NSString;
...
@property (assign,nonatomic) BOOL hasJunkiMessageChats;                                                      //@synthesize hasJunkiMessageChats=_hasJunkiMessageChats - In the implementation block
