...
@class NSExtensionContext, CKFullScreenBalloonViewControllerNotification, CKMessageEntryViewController, CKScheduledUpdater, CKRaiseGesture, CKMessageEntryView, NSString;
