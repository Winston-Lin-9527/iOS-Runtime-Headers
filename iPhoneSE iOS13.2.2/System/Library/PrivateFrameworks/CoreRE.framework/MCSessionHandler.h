...
@interface MCSessionHandler : NSObject <MCSessionPrivateDelegate> {
	...
	DynamicArray<re::SharedPtr<MCProtocolHandle> >* _handles;
...
@property (assign,nonatomic) DynamicArray<re::SharedPtr<MCProtocolHandle> >* handles;              //@synthesize handles=_handles - In the implementation block
...
-(DynamicArray<re::SharedPtr<MCProtocolHandle> >*)handles;
-(void)setHandles:(DynamicArray<re::SharedPtr<MCProtocolHandle> >*)arg1 ;
