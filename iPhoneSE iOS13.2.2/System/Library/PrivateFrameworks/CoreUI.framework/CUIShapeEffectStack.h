...
@property (nonatomic,readonly) SCD_Struct_CU37* hueSaturation;                     //@synthesize hueSaturation=_hueSaturation - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU38* colorOverlay;                      //@synthesize colorOverlay=_colorOverlay - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU39* innerGradient;                     //@synthesize innerGradient=_innerGradient - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU40* innerGlow;                         //@synthesize innerGlow=_innerGlow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU41* innerShadow;                       //@synthesize innerShadow=_innerShadow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU42* outerGlow;                         //@synthesize outerGlow=_outerGlow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU35* engraveShadow;                     //@synthesize engraveShadow=_engraveShadow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU35* extraShadow;                       //@synthesize extraShadow=_extraShadow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU43* emboss;                            //@synthesize emboss=_emboss - In the implementation block
...
+(id)gradientWithParameters:(SCD_Struct_CU39*)arg1 inRect:(CGRect)arg2 ;
...
-(SCD_Struct_CU35*)engraveShadow;
-(unsigned long long)extraShadowCount;
-(SCD_Struct_CU35*)extraShadow;
...
-(SCD_Struct_CU39*)innerGradient;
-(unsigned long long)colorOverlayCount;
-(SCD_Struct_CU38*)colorOverlay;
...
-(BOOL)hasEffects;
-(id)imageWithInteriorGradientFillOfImage:(id)arg1 effect:(SCD_Struct_CU39)arg2 ;
-(id)imageWithColorOverlayOfImage:(id)arg1 effect:(SCD_Struct_CU38)arg2 ;
-(id)imageWithHueSaturationOfImage:(id)arg1 effect:(SCD_Struct_CU37)arg2 ;
-(id)imageWithInnerGlowOfImage:(id)arg1 effect:(SCD_Struct_CU40)arg2 ;
-(id)imageWithInnerShadowOfImage:(id)arg1 effect:(SCD_Struct_CU41)arg2 ;
-(id)imageWithBevelEmbossOfImage:(id)arg1 effect:(SCD_Struct_CU43)arg2 ;
-(id)imageWithOuterGlowOfImage:(id)arg1 effect:(SCD_Struct_CU42)arg2 ;
-(id)imageWithEngraveShadowOfImage:(id)arg1 effect:(SCD_Struct_CU35)arg2 ;
-(id)imageWithExtraShadowOfImage:(id)arg1 effect:(SCD_Struct_CU35)arg2 ;
