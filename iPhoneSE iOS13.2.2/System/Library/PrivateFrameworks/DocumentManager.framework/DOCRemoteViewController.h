...
+(id)serviceExtension;
+(UIResilientRemoteViewContainerViewController*)instantiateRemoteViewControllerWithConfiguration:(id)arg1 transparent:(BOOL)arg2 errorHandler:(/*^block*/id)arg3 hostProxy:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
