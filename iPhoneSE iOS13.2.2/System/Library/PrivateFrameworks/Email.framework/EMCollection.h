...
@class NSMutableOrderedSet, NSOrderedSet, EFPromise, EFQuery, EFFuture, NSString;
...
@property (nonatomic,readonly) id<EFScheduler> queryScheduler;                                  //@synthesize queryScheduler=_queryScheduler - In the implementation block
