...
@class NSMutableDictionary, NSMapTable, EMMailboxScope, EMThreadScope, EFLazyCache, NSObject, EMMessageListChangeObserverHelper, EMMessageRepository, NSSet, NSString, EMObjectID;
...
@property (nonatomic,retain) EMMessageListChangeObserverHelper * changeObserverHelper;              //@synthesize changeObserverHelper=_changeObserverHelper - In the implementation block
...
-(EMMessageListChangeObserverHelper *)changeObserverHelper;
...
-(void)setChangeObserverHelper:(EMMessageListChangeObserverHelper *)arg1 ;
@end
