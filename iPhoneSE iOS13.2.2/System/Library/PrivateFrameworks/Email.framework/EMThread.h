...
@class EMMailboxScope, NSArray, NSDate, ECSubject, NSString, ECMessageFlags, NSIndexSet, EFQuery, EMMessageListChangeObserverHelper, EMMessageRepository, EMObjectID, EMMessage;
