...
@class NSMutableOrderedSet, NSMutableDictionary, EDVIPManager, EDMessageQueryHelper, NSArray, EDUpdateThrottler, EDThreadReloadSummaryHelper, NSObject, EMMailboxScope, NSString;
