...
-(void)writeCheckReportTo:(id)arg1 limitNumberOfItems:(BOOL)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)_createProvidedItemsDirectoryWithCompletion:(/*^block*/id)arg1 ;
...
-(void)_performForAllCoordinationProviders:(/*^block*/id)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)reconnectToFileCoordinatorForURL:(id)arg1 completion:(/*^block*/id)arg2 ;
