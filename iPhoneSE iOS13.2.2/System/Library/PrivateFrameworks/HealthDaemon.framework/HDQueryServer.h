...
@class NSDictionary, HKQueryServerConfiguration, NSArray, HDDataCollectionAssertion, HDDaemonTransaction, HDQueryServerClientState, NSObject, NSUUID, HDHealthStoreClient, HDProfile, _HKFilter, HKObjectType, NSSet, HKSampleType, HKQuantityType, NSString;
