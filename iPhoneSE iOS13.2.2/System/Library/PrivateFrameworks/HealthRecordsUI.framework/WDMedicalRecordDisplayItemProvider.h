...
@class NSDictionary, NSPredicate, HRProfile, HKConcept, NSMutableArray, NSArray, NSUUID, NSObject, WDMedicalRecordPagingContext, HKMultiTypeSampleIterator;
...
-(void)_displayItemGroupsForSummaryOfRecords:(id)arg1 style:(long long)arg2 completion:(/*^block*/id)arg3 ;
