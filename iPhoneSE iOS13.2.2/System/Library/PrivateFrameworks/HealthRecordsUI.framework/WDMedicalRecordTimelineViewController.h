...
@class WDMedicalRecordDisplayItemProvider, HRProfile, NSPredicate, NSUUID, HKClinicalAccount, WDMedicalRecordCategory, NSSet, HKConcept, UISearchController, NSTimer, HROverlayRoomViewController, HKViewTableViewCell, UIButton, HRContentStatusView, HRContentStatusCell, HKCloudSyncObserver, NSHashTable, NSString;
