...
@class NSArray, NSMutableArray, NSMutableDictionary, HKActivitySummaryDataProvider, HKSampleTypeUpdateController, HKHealthStore, HKUnitPreferenceController, NSString;
