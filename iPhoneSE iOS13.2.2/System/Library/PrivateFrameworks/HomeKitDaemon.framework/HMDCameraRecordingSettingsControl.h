...
@class NSObject, HMDHAPAccessory, HMDService, NSDictionary, HMDCameraRecordingGeneralConfiguration, HMDCameraRecordingSupportedVideoConfiguration, HMDCameraRecordingSupportedAudioConfiguration, NSMutableDictionary, HMDCameraRecordingSelectedConfiguration, NSString, NSDate, NSNumber;
