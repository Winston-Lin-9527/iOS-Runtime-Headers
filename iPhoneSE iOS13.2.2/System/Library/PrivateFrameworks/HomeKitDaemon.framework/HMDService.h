...
@class HMDApplicationData, NSUUID, NSNumber, NSString, HMDHAPAccessory, NSArray, HMDBulletinBoardNotification, HMFMessageDispatcher, NSMutableDictionary, HMDHome, NSSet;
