...
@property (nonatomic,retain) UIView * overlappingSupplementaryValueMarkingView;                                 //@synthesize overlappingSupplementaryValueMarkingView=_overlappingSupplementaryValueMarkingView - In the implementation block
...
-(void)setOverlappingSupplementaryValueMarkingView:(UIView *)arg1 ;
...
-(UIView *)overlappingSupplementaryValueMarkingView;
