...
@property (assign,nonatomic) BOOL homePodsActiveInStereoSetUp;                                                                                             //@synthesize homePodsActiveInStereoSetUp=_homePodsActiveInStereoSetUp - In the implementation block
...
-(BOOL)homePodsActiveInStereoSetUp;
...
-(void)setHomePodsActiveInStereoSetUp:(BOOL)arg1 ;
