...
@property (nonatomic,retain) NSMutableDictionary * pluginsBundleIDMap;                         //@synthesize pluginsBundleIDMap=_pluginsBundleIDMap - In the implementation block
...
-(NSMutableDictionary *)pluginsBundleIDMap;
...
-(void)setPluginsBundleIDMap:(NSMutableDictionary *)arg1 ;
