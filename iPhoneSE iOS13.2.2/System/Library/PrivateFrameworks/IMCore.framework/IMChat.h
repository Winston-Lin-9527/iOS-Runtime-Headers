...
@property (nonatomic,copy,readonly) NSString * participantIDsHash;                                    //@synthesize participantIDsHash=_participantIDsHash - In the implementation block
