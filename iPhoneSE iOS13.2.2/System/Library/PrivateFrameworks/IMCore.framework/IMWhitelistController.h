...
@class TUCallProviderManager, NSObject, NSSet, NSMutableDictionary, DMFApplicationPolicyMonitor, NSString;
...
@property (nonatomic,retain) NSMutableDictionary * participantIDsHashToChat;                             //@synthesize participantIDsHashToChat=_participantIDsHashToChat - In the implementation block
...
-(NSMutableDictionary *)participantIDsHashToChat;
...
-(void)setParticipantIDsHashToChat:(NSMutableDictionary *)arg1 ;
