...
-(BOOL)resetReaderTo:(SCD_Struct_MO4)arg1 error:(id*)arg2 ;
-(CVBufferRef)copyNextFrameForStream:(id)arg1 timestamp:(SCD_Struct_MO4*)arg2 error:(id*)arg3 ;
...
-(SCD_Struct_MO4)getMinFrameDurationForStream:(id)arg1 ;
