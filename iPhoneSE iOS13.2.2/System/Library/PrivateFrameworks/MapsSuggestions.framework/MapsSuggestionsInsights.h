...
-(BOOL)signalPackForDestinationMapItem:(GEOMapItemStorage*)arg1 originCoordinate:(CLLocationCoordinate2D)arg2 handler:(/*^block*/id)arg3 ;
...
-(id)signalPackForDestinationMapItem:(GEOMapItemStorage*)arg1 originCoordinate:(CLLocationCoordinate2D)arg2 ;
