...
@class NSObject, MapsSuggestionsCanKicker, MSPHistoryContainer, MSPFavoritesContainer, NSString;
...
-(id)_extractTitleAndSubtitleFromMapItem:(GEOMapItemStorage*)arg1 ;
@end
