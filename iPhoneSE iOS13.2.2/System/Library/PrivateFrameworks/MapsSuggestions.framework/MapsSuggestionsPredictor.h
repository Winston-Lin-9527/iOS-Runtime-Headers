...
-(BOOL)predictedTransportModeForDestinationMapItem:(GEOMapItemStorage*)arg1 originCoordinate:(CLLocationCoordinate2D)arg2 handler:(/*^block*/id)arg3;
...
-(BOOL)predictedTransportModeForDestinationEntry:(id)arg1 originCoordinate:(CLLocationCoordinate2D)arg2 handler:(/*^block*/id)arg3 ;
-(void)storeSignalPack:(id)arg1 forMapItem:(GEOMapItemStorage*)arg2 ;
-(BOOL)predictedTransportModeForDestinationMapItem:(GEOMapItemStorage*)arg1 originCoordinate:(CLLocationCoordinate2D)arg2 handler:(/*^block*/id)arg3 ;
-(void)captureActualTransportationMode:(int)arg1 originMapItem:(GEOMapItemStorage*)arg2 destinationMapItem:(GEOMapItemStorage*)arg3 ;
-(void)capturePredictedTransportationMode:(int)arg1 ;
-(void)cancelCapturingAnalytics;
