...
-(id)init;
-(NSString *)uniqueName;
-(BOOL)fetchSuggestedShortcutsForType:(long long)arg1 handler:(/*^block*/id)arg2 ;
...
-(void)_resolveMapItemsAndAddEntries:(NSArray*)arg1 handler:(/*^block*/id)arg2 ;
...
-(BOOL)fetchEntriesForLocation:(id)arg1 period:(NSDateInterval*)arg2 handler:(/*^block*/id)arg3 ;
