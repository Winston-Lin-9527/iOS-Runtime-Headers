...
@class NSString, NSUUID, NSArray, GEOMapItemStorage;
...
-(id)initWithType:(long long)arg1 identifier:(id)arg2 geoMapItem:(GEOMapItemStorage*)arg3 customName:(id)arg4 ;
-(id)initWithType:(long long)arg1 identifier:(id)arg2 geoMapItem:(GEOMapItemStorage*)arg3 customName:(id)arg4 contacts:(id)arg5 isHidden:(BOOL)arg6 originatingAddress:(id)arg7 ;
-(id)initWithType:(long long)arg1 geoMapItem:(GEOMapItemStorage*)arg2 customName:(id)arg3 ;
-(id)initWithGEOMapItem:(GEOMapItemStorage*)arg1 customName:(id)arg2 ;
