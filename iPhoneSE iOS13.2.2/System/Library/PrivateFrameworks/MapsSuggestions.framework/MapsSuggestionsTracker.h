...
@class NSObject, MapsSuggestionsManager, GEOLocationShifter, MapsSuggestionsETARequester, MapsSuggestionsDonater, MapsSuggestionsCanKicker, NSMutableDictionary, MapsSuggestionsFlightUpdater, MapsSuggestionsETARequirements, GEOAutomobileOptions, CLLocation, MapsSuggestionsMutableWeakEntries, MapsSuggestionsNetworkRequester, MapsSuggestionsPredictor, NSString;
