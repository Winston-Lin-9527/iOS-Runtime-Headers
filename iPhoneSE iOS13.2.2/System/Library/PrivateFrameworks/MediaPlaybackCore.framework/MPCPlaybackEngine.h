...
@class MPCAudioSpectrumAnalyzer, NSString, MPCPlaybackIntent, MPProtocolProxy, _MPCAVController, _MPCMediaRemotePublisher, _MPCReportingController, _MPCPlaybackEngineSessionManager, _MPCLeaseManager, _MPCPlaybackAccountManager, UIView, MPCPlayerPath;
