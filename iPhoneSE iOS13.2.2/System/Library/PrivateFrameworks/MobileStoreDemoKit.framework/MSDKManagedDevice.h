...
-(BOOL)sendF200EchoCommandWithOptions:(id)arg1 replyQueue:(id)arg2 withCompletion:(/*^block*/id)arg3 ;
...
-(BOOL)sendF200GenericCommandWithPayload:(id)arg1 replyQueue:(id)arg2 withCompletion:(/*^block*/id)arg3 ;
