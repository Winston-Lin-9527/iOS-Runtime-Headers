...
-(NSArray*)imageBatchFromMatrix:(id)arg1 m2iKernel:(id)arg2 cmdBuf:(id)arg3 width:(unsigned long long)arg4 height:(unsigned long long)arg5 channels:(unsigned long long)arg6 ;
-(id)tempMatrixFromImages:(NSArray*)arg1 i2mKernel:(id)arg2 cmdBuf:(id)arg3 ;
-(id)deduceDevice;
...
-(id)matrixFromImages:(NSArray*)arg1 i2mKernel:(id)arg2 cmdBuf:(id)arg3 ;
