...
-(void)updateInputToFirstKernel:(NSArray*)arg1 inference:(BOOL)arg2 ;
-(void)updatePrimaryCurrentState:(NSArray*)arg1 inference:(BOOL)arg2 ;
...
-(void)updateInputToFirstKernel:(NSArray*)arg1 index:(id)arg2 inference:(BOOL)arg3 ;
-(void)updatePrimaryCurrentState:(NSArray*)arg1 index:(id)arg2 inference:(BOOL)arg3 ;
-(NSMutableDictionary *)inputImagesToFirstKernel;
-(NSMutableDictionary *)primaryCurrentStates;
-(void)updateInputToSecondKernel:(NSArray*)arg1 inference:(BOOL)arg2 ;
-(void)updateSecondaryCurrentState:(NSArray*)arg1 inference:(BOOL)arg2 ;
...
-(void)updateInputToSecondKernel:(NSArray*)arg1 index:(id)arg2 inference:(BOOL)arg3 ;
-(void)updateSecondaryCurrentState:(NSArray*)arg1 index:(id)arg2 inference:(BOOL)arg3 ;
@end
