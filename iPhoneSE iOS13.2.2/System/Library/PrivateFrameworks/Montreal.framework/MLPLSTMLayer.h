...
-(void)updateSourceMatrix:(NSArray*)arg1 inference:(BOOL)arg2 ;
-(NSMutableArray *)trainingStates;
-(NSArray*)seqForwardDifferentMatrices:(id)arg1 input:(NSArray*)arg2 ;
-(NSArray*)seqForwardCombinedMatrix:(id)arg1 input:(NSArray*)arg2 ;
-(NSArray*)seqBackwardDifferentMatrices:(id)arg1 inputGradient:(NSArray*)arg2 ;
-(NSArray*)seqBackwardCombinedMatrix:(id)arg1 inputGradient:(NSArray*)arg2 ;
-(NSArray *)srcMatrices;
