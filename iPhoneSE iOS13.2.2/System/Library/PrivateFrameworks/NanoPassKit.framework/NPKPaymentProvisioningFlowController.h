...
@property (nonatomic,retain) NPKPaymentProvisioningFlowControllerRequestContext * digitalIssuanceRequestContext;                   //@synthesize digitalIssuanceRequestContext=_digitalIssuanceRequestContext - In the implementation block
...
-(NPKPaymentProvisioningFlowControllerRequestContext *)digitalIssuanceRequestContext;
-(void)setDigitalIssuanceRequestContext:(NPKPaymentProvisioningFlowControllerRequestContext *)arg1 ;
