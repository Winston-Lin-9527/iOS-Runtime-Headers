...
@class IDSService, NPKCompanionAgentConnection, NSMutableDictionary, NSObject, NRActiveDeviceAssertion, NPKTargetDeviceAssertionManager, NPKTapToRadarManager, NSString;
...
-(void)commutePlanReminderIntervalForCommutePlan:(id)arg1 pass:(id)arg2 completion:(/*^block*/id)arg3 ;
