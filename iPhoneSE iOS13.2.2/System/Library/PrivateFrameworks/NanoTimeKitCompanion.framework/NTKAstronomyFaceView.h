...
@class NTKDigitialUtilitarianFaceViewComplicationFactory, NTKDigitalTimeLabelStyle, NTKAstronomyRotationModel, UIPanGestureRecognizer, UITapGestureRecognizer, NTKDateComplicationLabel, UIImageView, NTKAstronomyVistaView, NTKColoringLabel, NTKAstronomyLocationDot, NSDate, NSDateFormatter, NTKDelayedBlock, NSArray, UIView, NSString;
