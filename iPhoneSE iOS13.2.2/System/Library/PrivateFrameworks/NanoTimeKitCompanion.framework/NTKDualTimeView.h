...
@class NSDate, NSCalendar, CAReplicatorLayer, UIView, CALayer, NSArray, NTKDigitalTimeLabelStyle, CLKFont, CLKDevice, NTKAnalogHandsView, NTKDigitalTimeLabel, NSString;
