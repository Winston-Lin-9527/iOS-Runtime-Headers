...
@class NSCalendar, NTKWhistlerAnalogFaceViewComplicationFactory, NSTimer, NTKSiderealDataSource, NTKSiderealDialBackgroundView, NTKSiderealAuxiliaryDialLabels, NTKSiderealTimeView, UILabel, UIView, CAShapeLayer, CALayer, NSDateFormatter, NTKFaceViewTapControl, NSString;
