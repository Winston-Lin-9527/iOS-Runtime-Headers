...
@class UIView, CAGradientLayer, CALayer, NTKBezierPathView, NTKSolarTimeModel, NTKSolarPath, NTKBezierPathPointModel, NSDictionary, CLKDevice, CLLocation, NSDate, NSString;
