...
@protocol FCAppActivityMonitor, FCPurchaseProviderType, FCPurchaseManagerType, FCBundleSubscriptionManagerType, FCCurrentIssuesChecker, FCPaidAccessCheckerType, FCFlintHelper, FCBackgroundTaskable, FCForYouMagazineFeedManaging, FCPPTContext, FCContentContext, FCPrivateDataContext;
