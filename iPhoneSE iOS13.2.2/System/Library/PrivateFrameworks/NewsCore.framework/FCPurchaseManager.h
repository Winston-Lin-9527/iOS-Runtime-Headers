...
@protocol FCPurchaseManagerDelegate, FCPaymentTransactionManager, FCPurchaseIntegrityChecker, FCPurchaseReceiptProvider, FCBundleSubscriptionManagerType, FCCoreConfigurationManager;
