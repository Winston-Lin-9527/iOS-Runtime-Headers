...
@class NSDate, NSString, FCAssetHandle, FCColor, NSArray, NTPBPublisherPaidDescriptionStrings, FCSubscriptionButtonConfiguration, NSData, FCTagBanner, FCTextInfo, FCHeadlineTemplate, FCInterestToken, NTPBFeedConfiguration, NTPBTagRecord;
...
@property (nonatomic,copy,readonly) FCSubscriptionButtonConfiguration * paidBundleSubscriptionButtonConfiguration;              //@synthesize paidBundleSubscriptionButtonConfiguration=_paidBundleSubscriptionButtonConfiguration - In the implementation block
