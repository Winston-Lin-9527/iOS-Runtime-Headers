...
@class NSDate, NSString, FCAssetHandle, FCColor, NSArray, NTPBPublisherPaidDescriptionStrings, FCSubscriptionButtonConfiguration, NSData;
...
@property (nonatomic,copy,readonly) FCSubscriptionButtonConfiguration * paidBundleSubscriptionButtonConfiguration; 
