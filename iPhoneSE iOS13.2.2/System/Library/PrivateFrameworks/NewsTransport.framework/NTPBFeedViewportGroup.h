...
@property (nonatomic,retain) NTPBColor * darkStyleCardBackgroundColor;                         //@synthesize darkStyleCardBackgroundColor=_darkStyleCardBackgroundColor - In the implementation block
@property (nonatomic,readonly) BOOL hasDarkStyleSauceGradient; 
@property (nonatomic,retain) NTPBColorGradient * darkStyleSauceGradient;                       //@synthesize darkStyleSauceGradient=_darkStyleSauceGradient - In the implementation block
+(Class)issueIDsType;
+(Class)headlinesType;
...
-(NTPBColor *)darkStyleCardBackgroundColor;
-(NTPBColorGradient *)sauceGradient;
-(NTPBColorGradient *)darkStyleSauceGradient;
...
-(void)setDarkStyleCardBackgroundColor:(NTPBColor *)arg1 ;
-(void)setDarkStyleBackgroundGradient:(NTPBColorGradient *)arg1 ;
-(void)setSauceGradient:(NTPBColorGradient *)arg1 ;
-(void)setDarkStyleSauceGradient:(NTPBColorGradient *)arg1 ;
