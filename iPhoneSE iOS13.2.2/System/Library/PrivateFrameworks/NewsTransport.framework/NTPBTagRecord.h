...
@property (nonatomic,retain) NSString * paidBundleSubscriptionButtonConfigurationJson;                           //@synthesize paidBundleSubscriptionButtonConfigurationJson=_paidBundleSubscriptionButtonConfigurationJson - In the implementation block
...
-(void)setPaidBundleSubscriptionButtonConfigurationJson:(NSString *)arg1 ;
...
-(NSString *)paidBundleSubscriptionButtonConfigurationJson;
