...
@class ICAttachment, ICSearchResult, NSRegularExpression, ICAttachmentBrickFrostedView, NSLayoutConstraint, NSString, ICAttachmentBrickTextViewV2, UIView, UIImage;
