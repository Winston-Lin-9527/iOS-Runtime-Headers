...
-(void)_authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(UIWindow*)arg3 failedAttemptHandler:(/*^block*/id)arg4 completionHandler:(/*^block*/id)arg5 ;
-(id)displayedSheet;
-(void)showPasswordSetUpSheetForAccount:(id)arg1 displayWindow:(UIWindow*)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)showPasswordEntrySheetWithIntent:(unsigned long long)arg1 note:(id)arg2 displayWindow:(UIWindow*)arg3 failedAttemptHandler:(/*^block*/id)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(void)authenticateForNote:(id)arg1 intent:(unsigned long long)arg2 displayWindow:(UIWindow*)arg3 failedAttemptHandler:(/*^block*/id)arg4 completionHandler:(/*^block*/id)arg5 ;
