...
-(id)validAdjacentParagraphInfoFromParagraphInfo:(id)arg1 inDirection:(unsigned long long)arg2 inTextView:(UITextView*)arg3 ;
-(id)trackedParagraphsForTodosInRange:(NSRange)arg1 textStorage:(id)arg2 ;
-(NSMutableDictionary *)trackedToDoParagraphs;
-(id)createTreeFromTrackedParagraphs:(id)arg1 textView:(ICBaseTextView*)arg2 ;
-(BOOL)moveCheckedChecklistsToBottomInTextView:(ICTextView*)arg1 forRange:(NSRange)arg2 animated:(BOOL)arg3 ;
-(void)applySortFromOriginalParagraphs:(id)arg1 sortedTrackedParagraphs:(id)arg2 forTextView:(ICTextView*)arg3 checklistRange:(NSRange)arg4 ;
-(void)performAnimatedSortForTrackedParagraphs:(id)arg1 expandedRange:(NSRange)arg2 textView:(ICTextView*)arg3 sortChecklistsBlock:(/*^block*/id)arg4 ;
...
-(void)showFirstTimeAutoSortEnabledAlertIfNecessaryWithTextView:(ICBaseTextView*)arg1 completionHandler:(/*^block*/id)arg2 analyticsHandler:(/*^block*/id)arg3 ;
-(void)showFirstTimeAutoSortEnabledAlertWithTextView:(ICBaseTextView*)arg1 completionHandler:(/*^block*/id)arg2 analyticsHandler:(/*^block*/id)arg3 ;
...
-(BOOL)moveListItemInDirection:(unsigned long long)arg1 inTextView:(UITextView*)arg2 forRange:(NSRange)arg3 ;
-(BOOL)canMoveListItemInDirection:(unsigned long long)arg1 inTextView:(UITextView*)arg2 forRange:(NSRange)arg3 ;
-(id)expandedChecklistTrackedParagraphsInTextView:(UITextView*)arg1 forIndex:(long long)arg2 ;
-(id)adjacentTrackedParagraphFromTrackedParagraph:(id)arg1 inDirection:(unsigned long long)arg2 inTextView:(UITextView*)arg3 ;
...
-(void)autoSortChecklistIfNecessaryForTrackedParagraph:(id)arg1 textView:(ICBaseTextView*)arg2 analyticsHandler:(/*^block*/id)arg3 ;
-(void)autoSortChecklistForUnitTestAtIndex:(unsigned long long)arg1 textView:(ICTextView*)arg2 ;
-(id)analyticsInfoForChecklistAtIndex:(unsigned long long)arg1 textView:(ICBaseTextView*)arg2 ;
...
-(void)setSelectionToIndex:(unsigned long long)arg1 onTextView:(UITextView*)arg2 ;
...
-(id)imageInfoForTrackedParagraph:(id)arg1 textView:(ICBaseTextView*)arg2 characterRangeToRender:(NSRange)arg3 visibleRectToRender:(CGRect)arg4 ;
-(void)addImageViewsBeforeSortIfNecessaryForTrackedInfos:(id)arg1 textView:(ICBaseTextView*)arg2 textContainerOrigin:(CGPoint)arg3 todoUUIDsToImageViews:(id)arg4 ;
-(void)addImageViewsAfterSortIfNecessaryForTrackedInfos:(id)arg1 existingInfos:(id)arg2 textView:(ICBaseTextView*)arg3 textContainerOrigin:(CGPoint)arg4 todoUUIDsToImageViews:(id)arg5 ;
-(void)setFinalFramesForSortedInfos:(id)arg1 textView:(ICBaseTextView*)arg2 textContainerOrigin:(CGPoint)arg3 todoUUIDsToImageViews:(id)arg4 ;
@end
