...
-(SCD_Struct_WD109)dropCap;
-(void)setDropCap:(SCD_Struct_WD109)arg1 ;
-(unsigned long long)tabStopAddedCount;
-(void)setTabStopAddedCount:(unsigned long long)arg1 ;
-(SCD_Struct_WD110*)tabStopAddedAt:(unsigned long long)arg1 ;
-(void)addTabStopAdded:(SCD_Struct_WD110*)arg1 ;
