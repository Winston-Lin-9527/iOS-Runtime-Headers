...
@class NSString, NSDecimalNumber, NSDate, PKMerchant, NSTimeZone, NSNumber, NSData, PKPaymentTransactionForeignExchangeInformation, PKPaymentTransactionFees, NSUUID, PKPaymentTransactionRewards, NSSet, NSOrderedSet, NSArray, PKAccountEvent, PKInstallmentPlanPayment, PKInstallmentPlan, NSDictionary, PKCurrencyAmount, CLLocation;
