...
@class PKPaymentSetupFooterView, RemoteUIController, CLInUseAssertion, UINotificationFeedbackGenerator, PKPaymentVerificationController, NSTimer, NSString, PKPasscodeUpgradeFlowController, PKPaymentProvisioningController;
