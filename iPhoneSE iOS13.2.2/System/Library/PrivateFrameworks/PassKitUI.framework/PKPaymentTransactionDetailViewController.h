...
@class PKPaymentTransaction, NSArray, PKPaymentTransactionCellController, PKAccountServiceAccountResolutionController, NSString, PKPaymentPass, PKPaymentTransactionDetailHeaderView, PKPeerPaymentContactResolver, PKPeerPaymentController, UIImage, PKPeerPaymentStatusResponse, NSDateFormatter, NSTimeZone;
