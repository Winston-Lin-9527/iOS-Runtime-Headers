...
@class PKPaymentPass, PKDashboardTransactionFetcher, PKPeerPaymentContactResolver, PKPaymentTransaction, PKPaymentTransactionGroup, PKInstallmentPlan, NSArray, NSDateFormatter, NSCalendar, PKAccount, CNContact, PKMerchant, PKCurrencyAmount, NSString;
