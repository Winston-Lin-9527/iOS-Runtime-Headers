...
@property (nonatomic,readonly) NSDate * previousSourceDate;                              //@synthesize previousSourceDate=_previousSourceDate - In the implementation block
