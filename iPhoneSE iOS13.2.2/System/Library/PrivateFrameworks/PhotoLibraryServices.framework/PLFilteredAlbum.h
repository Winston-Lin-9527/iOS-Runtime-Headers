...
@class NSString, NSDictionary, NSDate, NSOrderedSet, NSNumber, NSIndexSet, PLIndexMapper, NSMutableIndexSet, NSMutableOrderedSet, NSPredicate, NSArray, PLManagedAsset, PLPhotoLibrary, NSObject, NSURL;
