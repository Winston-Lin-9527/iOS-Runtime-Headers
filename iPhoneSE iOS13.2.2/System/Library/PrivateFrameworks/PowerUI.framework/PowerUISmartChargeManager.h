...
@interface PowerUISmartChargeManager : NSObject <UNUserNotificationCenterDelegate, NSXPCListenerDelegate, PowerUISignalMonitorDelegate, PowerUISmartChargeManagingPrivate, PowerUISmartChargeManaging> {
	...
	long long _lastDecisionMakerID;
...
@property (assign,nonatomic) long long lastDecisionMakerID;                                             //@synthesize lastDecisionMakerID=_lastDecisionMakerID - In the implementation block
...
-(long long)lastDecisionMakerID;
-(void)setLastDecisionMakerID:(long long)arg1 ;
