...
@interface PMLDiffPrivacyNoiseStrategy : NSObject <PMLNoiseStrategy> {
	...
	SCD_Struct_PM10 _noiseScaleFactors;
	long long _noiseMechanism;

}

@property (assign) SCD_Struct_PM10 noiseScaleFactors;               //@synthesize noiseScaleFactors=_noiseScaleFactors - In the implementation block
...
-(id)initWithMaxIterationCount:(int)arg1 noiseScaleFactors:(SCD_Struct_PM10)arg2 minimumMagnitude:(float)arg3 seed:(int)arg4 noiseMechanism:(long long)arg5 inplaceNorm:(BOOL)arg6 ;
-(id)initWithMaxIterationCount:(int)arg1 noiseScaleFactors:(SCD_Struct_PM10)arg2 minimumMagnitude:(float)arg3 noiseMechanism:(long long)arg4 inplaceNorm:(BOOL)arg5 ;
...
-(SCD_Struct_PM10)noiseScaleFactors;
-(void)setNoiseScaleFactors:(SCD_Struct_PM10)arg1 ;
