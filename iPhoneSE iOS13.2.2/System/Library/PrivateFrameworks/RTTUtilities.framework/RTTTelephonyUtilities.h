...
@class ACAccountStore, AXDispatchTimer, CTXPCServiceSubscriptionContext, NSSet, CNContactStore, CoreTelephonyClient, NSObject, NSNumber, NSString;
...
@property (nonatomic,retain) NSSet * allVoiceContexts;                                           //@synthesize allVoiceContexts=_allVoiceContexts - In the implementation block
...
@property (nonatomic,retain) NSNumber * callCapabilitiesSupportsTelephonyCalls;                  //@synthesize callCapabilitiesSupportsTelephonyCalls=_callCapabilitiesSupportsTelephonyCalls - In the implementation block
