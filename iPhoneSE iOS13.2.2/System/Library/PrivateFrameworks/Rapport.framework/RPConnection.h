...
@class NSString, NSObject, NSError, NSData, CUPairingStream, CUPairingSession, NSDictionary, CUBLEConnection, NSUUID, CUBonjourDevice, CUBluetoothScalablePipe, RPIdentity, CUHomeKitManager, RPIdentityDaemon, RPCompanionLinkDevice, CUNetLinkManager, CUTCPConnection;
