...
@class REMReplicaIDSource, NSMutableArray, CRDocument, NSOrderedSet;
...
-(CRDocument *)document;
-(id)serializedData;
-(id)initWithReplicaIDSource:(id)arg1 document:(CRDocument*)arg2 undos:(id)arg3 ;
-(id)initWithReplicaIDSource:(id)arg1 document:(CRDocument*)arg2 ;
