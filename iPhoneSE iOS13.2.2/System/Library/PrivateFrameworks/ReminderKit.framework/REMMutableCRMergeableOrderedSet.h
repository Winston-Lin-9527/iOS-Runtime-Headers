...
@class REMReplicaIDSource, REMReplicaIDHelper, NSMutableArray, REMMutableCRUndo, CRDocument, NSString;
...
-(id)initWithReplicaIDSource:(id)arg1 immutableDocumentToEdit:(CRDocument*)arg2 undos:(id)arg3 ;
