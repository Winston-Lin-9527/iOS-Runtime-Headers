...
@interface SEEndPointConfiguration : NSObject <SEEndPointConfiguration, NSSecureCoding> {
	...
	BOOL _localValidationMayBeRequested;
	BOOL _localValidationOnContactlessStatic;
	BOOL _localValidationOnContactless;
	BOOL _localValidationOnWireStatic;
	BOOL _localValidationOnWire;
...
@property (assign) BOOL localValidationMayBeRequested;                      //@synthesize localValidationMayBeRequested=_localValidationMayBeRequested - In the implementation block
@property (assign) BOOL localValidationOnContactlessStatic;                 //@synthesize localValidationOnContactlessStatic=_localValidationOnContactlessStatic - In the implementation block
@property (assign) BOOL localValidationOnContactless;                       //@synthesize localValidationOnContactless=_localValidationOnContactless - In the implementation block
@property (assign) BOOL localValidationOnWireStatic;                        //@synthesize localValidationOnWireStatic=_localValidationOnWireStatic - In the implementation block
@property (assign) BOOL localValidationOnWire;                              //@synthesize localValidationOnWire=_localValidationOnWire - In the implementation block
...
-(void)setLocalValidationMayBeRequested:(BOOL)arg1 ;
-(void)setLocalValidationOnContactlessStatic:(BOOL)arg1 ;
-(void)setLocalValidationOnContactless:(BOOL)arg1 ;
-(void)setLocalValidationOnWireStatic:(BOOL)arg1 ;
-(void)setLocalValidationOnWire:(BOOL)arg1 ;
...
-(BOOL)localValidationMayBeRequested;
-(BOOL)localValidationOnContactlessStatic;
-(BOOL)localValidationOnContactless;
-(BOOL)localValidationOnWireStatic;
-(BOOL)localValidationOnWire;
