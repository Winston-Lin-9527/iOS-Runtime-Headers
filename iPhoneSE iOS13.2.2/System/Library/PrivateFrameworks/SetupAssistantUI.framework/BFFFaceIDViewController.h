...
@interface BFFFaceIDViewController : OBSplashController <BKUIPearlEnrollControllerDelegate, BYEnvironmentDependencyReceiver> {
	...
	BOOL _inDemo;
	BOOL _supportsPaymentRegistration;
...
@property (assign,nonatomic) BOOL supportsPaymentRegistration;                                                     //@synthesize supportsPaymentRegistration=_supportsPaymentRegistration - In the implementation block
...
-(void)setSupportsPaymentRegistration:(BOOL)arg1 ;
-(id)initInDemo:(BOOL)arg1 ;
-(BOOL)supportsPaymentRegistration;
-(BOOL)inDemo;
