...
@property (nonatomic,retain) LPLinkMetadataObserver * headerMetadataObserver;                         //@synthesize headerMetadataObserver=_headerMetadataObserver - In the implementation block
...
-(LPLinkMetadataObserver *)headerMetadataObserver;
-(void)setHeaderMetadataObserver:(LPLinkMetadataObserver *)arg1 ;
