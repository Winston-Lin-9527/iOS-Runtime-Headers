...
@class SXEmbedResource, WKWebView, SXWebCrashRetryThrottler, UILabel, NSString, NSMutableSet, UIActivityIndicatorView, WKNavigation, NFMultiDelegate, WKWebsiteDataStore, SXRelatedWebViewCache;
...
-(void)willPresentComponentWithChanges:(SCD_Struct_SX16)arg1 ;
