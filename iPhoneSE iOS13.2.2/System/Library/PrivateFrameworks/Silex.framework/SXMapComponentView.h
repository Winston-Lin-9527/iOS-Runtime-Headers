...
@property (assign,nonatomic) SCD_Struct_SX20 mapRect;                                                        //@synthesize mapRect=_mapRect - In the implementation block
...
-(void)setMapRect:(SCD_Struct_SX20)arg1 ;
-(void)setMapView:(MKMapView *)arg1 ;
-(MKMapView *)mapView;
-(void)discardContents;
-(NSArray *)annotations;
-(void)setAnnotations:(NSArray *)arg1 ;
-(SCD_Struct_SX20)mapRect;
