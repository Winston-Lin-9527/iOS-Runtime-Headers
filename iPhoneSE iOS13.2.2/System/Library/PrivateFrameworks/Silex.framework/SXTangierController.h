...
@class STTextTangierDocumentRoot, STTextTangierCanvasViewController, STTextTangierInteractiveCanvasController, SXViewport, STScrollView, STTangierTextRenderCollector, STTangierRepDirectLayerHostProvider, UIView, TSWPSelection, NSMutableSet, NSString, TSKDocumentRoot;
