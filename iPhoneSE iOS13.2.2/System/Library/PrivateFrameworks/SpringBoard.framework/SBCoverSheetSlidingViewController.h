...
@class UIViewController, SBScreenEdgePanGestureRecognizer, SBCoverSheetSystemGesturesDelegate, CSCoverSheetTransitionSettings, SBCoverSheetPositionView, SBHomeGestureSettings, CSLockScreenSettings, UIViewFloatAnimatableProperty, NSObject, NSString;
...
-(void)_presentCoverSheetAnimated:(BOOL)arg1 withCompletion:(/*^block*/id)arg2 ;
