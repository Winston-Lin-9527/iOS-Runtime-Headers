...
@class SBFluidSwitcherViewController, SBMainDisplaySceneLayoutViewController, SBHomeGrabberView, SBAppSwitcherSettings, SBHomeGestureSettings, SBFHomeGrabberSettings, SBReachabilitySettings, SBHomeGestureParticipant, SBFluidSwitcherPanGestureRecognizer, SBGrabberTongue, UINotificationFeedbackGenerator, NSTimer, UIView, SBSwitcherForcePressSystemGestureRecognizer, SBFluidScrunchGestureRecognizer, SBPanSystemGestureRecognizer, SBMainDisplaySceneLayoutDragAndDropInteractionManager, SBFluidSwitcherGestureWorkspaceTransaction, NSString;
