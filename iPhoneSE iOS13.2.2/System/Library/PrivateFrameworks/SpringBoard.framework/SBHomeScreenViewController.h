...
@class NSMutableSet, SBFloatingDockBehaviorAssertion, SBAppStatusBarSettingsAssertion, UIView, SBFloatingDockWindowLevelAssertion, SBIconController, SBUIController, SBHIconManager, _UILegibilitySettings;
