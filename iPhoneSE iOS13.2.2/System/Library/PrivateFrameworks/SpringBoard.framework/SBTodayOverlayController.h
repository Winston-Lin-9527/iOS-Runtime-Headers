...
@class NSHashTable, SBMainScreenActiveInterfaceOrientationWindow, SBBarSwipeAffordanceViewController, SBTodayOverlayViewController, SBHomeGesturePanGestureRecognizer, FBDisplayLayoutElement, SBAppStatusBarDateTimeAssertion, NSString;
...
@property (nonatomic,readonly) SBHomeGesturePanGestureRecognizer * dismissHomeGestureRecognizer;               //@synthesize dismissHomeGestureRecognizer=_dismissHomeGestureRecognizer - In the implementation block
...
@property (nonatomic,readonly) unsigned long long systemGestureType;                                           //@synthesize systemGestureType=_systemGestureType - In the implementation block
...
-(SBHomeGesturePanGestureRecognizer *)dismissHomeGestureRecognizer;
