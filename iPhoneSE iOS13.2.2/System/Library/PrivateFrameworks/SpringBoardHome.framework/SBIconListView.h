...
@class NSMutableArray, NSMapTable, SBIconListViewDraggingDestinationDelegate, _UILegibilitySettings, SBIconListModel, NSString, SBFolderIconImageCache, SBHIconImageCache, SBIconListViewIconLocationTransitionHandler, NSArray;
