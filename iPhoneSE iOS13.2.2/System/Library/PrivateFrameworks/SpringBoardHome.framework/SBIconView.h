...
@property (assign,nonatomic,__weak) SBIconView * activePreviewIcon;                                                  //@synthesize activePreviewIcon=_activePreviewIcon - In the implementation block
...
-(void)setActivePreviewIcon:(SBIconView *)arg1 ;
