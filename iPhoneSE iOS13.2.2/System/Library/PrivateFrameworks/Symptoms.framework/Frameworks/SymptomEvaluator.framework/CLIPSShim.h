...
@interface CLIPSShim : NSObject {
	...
	SCD_Struct_CL48* _consoleNameRegex;
	SCD_Struct_CL48* _dumpStringRegex;
...
@property (assign,nonatomic) SCD_Struct_CL49* consoleNameRegex;                    //@synthesize consoleNameRegex=_consoleNameRegex - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL49* dumpStringRegex;                     //@synthesize dumpStringRegex=_dumpStringRegex - In the implementation block
...
-(SCD_Struct_CL49*)consoleNameRegex;
-(void)setConsoleNameRegex:(SCD_Struct_CL49*)arg1 ;
-(SCD_Struct_CL49*)dumpStringRegex;
-(void)setDumpStringRegex:(SCD_Struct_CL49*)arg1 ;
