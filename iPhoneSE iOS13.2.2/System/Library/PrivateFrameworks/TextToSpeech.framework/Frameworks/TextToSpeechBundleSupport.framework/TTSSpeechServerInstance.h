...
-(void)processMarker:(long long)arg1 withByteOffset:(unsigned)arg2 markerPosition:(unsigned)arg3 markerLength:(unsigned)arg4 context:(SCD_Struct_TT9*)arg5 currentTime:(unsigned long long)arg6 ;
