...
@property (assign) BOOL internalBuildOnly;                                                 //@synthesize internalBuildOnly=_internalBuildOnly - In the implementation block
...
+(id)loadArtifactWithExperimentId:(NSString*)arg1 ;
+(id)artifactWithExperimentId:(NSString*)arg1 ;
+(id)urlForExperimentWithId:(NSString*)arg1 ;
