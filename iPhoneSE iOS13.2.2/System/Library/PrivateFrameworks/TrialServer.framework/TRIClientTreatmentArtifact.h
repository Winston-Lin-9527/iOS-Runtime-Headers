...
@class TRIClientTreatment, NSArray, NSString, NSData, NSDictionary;
...
+(id)artifactWithTreatmentId:(NSString*)arg1 ;
+(id)artifactFromCloudKitResult:(id)arg1 assetUrls:(id)arg2 ;
+(id)loadArtifactWithTreatmentId:(NSString*)arg1 ;
+(id)urlForDefaultTreatmentWithNamespaceId:(unsigned)arg1 ;
+(id)urlForTreatment:(NSString*)arg1 namespaceId:(unsigned)arg2 ;
-(id)init;
-(BOOL)isValid;
-(id)url;
-(id)_assetMap;
...
-(id)initWithTreatmentId:(NSString*)arg1 ;
-(NSArray *)assetUrls;
-(BOOL)updateFileValue:(id)arg1 ;
-(BOOL)copyAssets;
-(void)setTreatmentUrls:(NSDictionary *)arg1 ;
-(id)assetUrlForFactor:(id)arg1 treatmentId:(NSString*)arg2 ;
