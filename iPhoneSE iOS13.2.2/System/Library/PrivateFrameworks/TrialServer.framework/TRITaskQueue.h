...
-(BOOL)removeTaskWithId:(NSNumber*)arg1 ;
-(void)finishedTask:(id)arg1 withId:(NSNumber*)arg2 status:(int)arg3 ;
-(id)createOperationWithTask:(id)arg1 withId:(NSNumber*)arg2 dependencies:(id)arg3 taskMap:(id)arg4 ;
-(BOOL)_addTask:(id)arg1 taskIds:(id)arg2 ;
-(NSNumber*)_addTask:(id)arg1 withDependencies:(id)arg2 ;
...
-(BOOL)containsTaskId:(NSNumber*)arg1 ;
