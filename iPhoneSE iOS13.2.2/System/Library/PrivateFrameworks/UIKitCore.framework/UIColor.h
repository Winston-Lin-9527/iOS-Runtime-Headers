...
@interface UIColor : NSObject <LPCSSText, LPHTMLAttributeText, NSItemProviderReading, NSItemProviderWriting, UIItemProviderReading, UIItemProviderWriting, NSSecureCoding, NSCopying> {
