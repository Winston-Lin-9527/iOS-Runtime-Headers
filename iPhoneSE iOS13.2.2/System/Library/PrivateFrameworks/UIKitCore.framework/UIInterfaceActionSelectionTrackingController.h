...
@class UIView, UIScrollView, NSArray, UILongPressGestureRecognizer, _UIInterfaceActionSelectionDelayGestureRecognizer, UIGestureRecognizer, NSMutableSet, _UIInterfaceActionSelectByPressGestureRecognizer, UISelectionFeedbackGenerator, NSPointerArray, NSString;
