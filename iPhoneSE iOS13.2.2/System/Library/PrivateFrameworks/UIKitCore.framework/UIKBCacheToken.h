...
@property (assign,nonatomic) SCD_Struct_UI77 styling; 
...
+(id)tokenForKey:(id)arg1 style:(SCD_Struct_UI77)arg2 ;
...
+(id)tokenForKeyMask:(id)arg1 style:(SCD_Struct_UI77)arg2 displayInsets:(UIEdgeInsets)arg3 ;
...
-(void)setStyling:(SCD_Struct_UI77)arg1 ;
