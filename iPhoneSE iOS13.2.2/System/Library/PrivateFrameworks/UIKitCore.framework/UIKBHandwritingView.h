...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI82 _previousPoint;
...
@property (assign,nonatomic) SCD_Struct_UI81 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI81)arg1 ;
-(BOOL)initialPointPosted;
-(SCD_Struct_UI81)previousPoint;
