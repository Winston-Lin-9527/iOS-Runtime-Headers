...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate> {
	...
	SCD_Struct_UI43 _interactiveScrollNavBarIntrinsicHeightRange;
...
-(double)_navigationBar:(id)arg1 preferredHeightForTransitionToHeightRange:(SCD_Struct_UI43)arg2 ;
...
-(SCD_Struct_UI44)_calculateTopLayoutInfoForViewController:(id)arg1 ;
...
-(SCD_Struct_UI43)_intrinsicNavigationBarHeightRangeForNavItem:(id)arg1 ;
...
-(SCD_Struct_UI43)_heightRangeOfTopViews;
