...
@class NSMutableDictionary, NSValue, _UISearchBarSearchFieldBackgroundView, UIImageView, NSHashTable, _UISearchBarTextFieldTokenCounter, UITapGestureRecognizer, UISearchBar, UIColor, NSArray, UITextRange, NSString;
