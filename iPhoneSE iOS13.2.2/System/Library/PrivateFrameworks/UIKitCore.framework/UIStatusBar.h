...
@interface UIStatusBar : UIStatusBar_Base <UIStatusBarServerClient> {
	...
	SCD_Struct_UI104 _currentRawData;
...
+(void)getData:(SCD_Struct_UI104*)arg1 forRequestedData:(const SCD_Struct_UI104*)arg2 withOverrides:(const SCD_Struct_UI107*)arg3 ;
