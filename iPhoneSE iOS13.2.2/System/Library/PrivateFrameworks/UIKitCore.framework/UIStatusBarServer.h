...
+(void)postStatusBarData:(const SCD_Struct_UI104*)arg1 withActions:(int)arg2 ;
+(void)postStatusBarOverrideData:(SCD_Struct_UI107*)arg1 ;
+(void)permanentizeStatusBarOverrideData;
+(id)_cachedTimeStringFromData:(SCD_Struct_UI104*)arg1 ;
+(const SCD_Struct_UI104*)getStatusBarData;
+(SCD_Struct_UI107*)getStatusBarOverrideData;
