...
@interface UIStatusBarServerListener : NSObject {
	...
	SCD_Struct_UI104 _statusBarData;
	SCD_Struct_UI104 _composedStatusBarData;
	SCD_Struct_UI105 _overrides;
...
-(SCD_Struct_UI107*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI104*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI107*)arg1 ;
