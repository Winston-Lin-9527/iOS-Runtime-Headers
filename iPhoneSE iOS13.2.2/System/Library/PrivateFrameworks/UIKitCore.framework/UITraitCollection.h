...
@interface UITraitCollection : NSObject <_UIFallbackEnvironment, NSCopying, NSSecureCoding> {
	...
	SCD_Struct_UI72 _builtinTraits;
...
-(id)_initWithBuiltinTraitStorage:(SCD_Struct_UI72*)arg1 clientDefinedTraits:(id)arg2 ;
...
-(id)_initWithBuiltinTraitStorage:(SCD_Struct_UI72*)arg1 clientDefinedTraits:(id)arg2 environmentWrapper:(id)arg3 ;
