...
@class UIView, UIUndoGestureObserver, UITapGestureRecognizer, UIUndoGestureRecognizer, UIUndoLongPressGestureRecognizer, UIUndoPinchGestureRecognizer, UIKBUndoInteractionHUD, UIKBUndoStateHUD, NSLayoutConstraint, UIDelayedAction, UILayoutGuide, UIKBTextEditingTraits, NSString;
...
@property (nonatomic,retain) UIUndoLongPressGestureRecognizer * threeFingerLongPress;              //@synthesize threeFingerLongPress=_threeFingerLongPress - In the implementation block
...
-(UIUndoLongPressGestureRecognizer *)threeFingerLongPress;
-(void)threeFingerLongPress:(id)arg1 ;
-(void)setThreeFingerLongPress:(UIUndoLongPressGestureRecognizer *)arg1 ;
