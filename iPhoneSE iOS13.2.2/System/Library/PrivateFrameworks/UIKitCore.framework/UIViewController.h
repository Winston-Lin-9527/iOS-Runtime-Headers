...
@interface UIViewController : UIResponder <NSExtensionRequestHandling, _UIFallbackEnvironment, _UIViewServiceDeputy, UIWindowDelegate, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, _UIStatusBarAnimationProviding, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
	...
	SCD_Struct_UI5 _presentationSizeClassPair;
...
@property (nonatomic,readonly) SCD_Struct_UI5 __sizeClassPair; 
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI5 presentationSizeClassPair;                                                     //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(void)_getRotationContentSettings:(SCD_Struct_UI42*)arg1 ;
...
-(void)getRotationContentSettings:(SCD_Struct_UI42*)arg1 forWindow:(id)arg2 ;
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI5)arg1 ;
...
-(void)_setHostAuditToken:(SCD_Struct_UI47)arg1 ;
...
-(SCD_Struct_UI47)_hostAuditToken;
