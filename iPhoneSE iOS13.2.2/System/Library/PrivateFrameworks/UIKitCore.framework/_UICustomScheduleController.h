...
@interface _UICustomScheduleController : NSObject {
	...
	SCD_Struct_UI6 _schedule;

}

@property (assign,nonatomic) SCD_Struct_UI6 schedule;                                    //@synthesize schedule=_schedule - In the implementation block
@property (getter=isInScheduleTime,nonatomic,readonly) BOOL inScheduleTime; 
-(id)init;
-(void)dealloc;
-(void)removeObserver:(id)arg1 ;
-(SCD_Struct_UI6)schedule;
...
-(void)setSchedule:(SCD_Struct_UI6)arg1 ;
