...
@interface _UIFlowLayoutInfo : NSObject {
	...
	SCD_Struct_UI34 _rowAlignmentOptions;
	CGSize _contentSize;
...
@property (assign,nonatomic) SCD_Struct_UI34 rowAlignmentOptions;                     //@synthesize rowAlignmentOptions=_rowAlignmentOptions - In the implementation block
...
-(BOOL)horizontal;
-(SCD_Struct_UI34)rowAlignmentOptions;
...
-(id)addSection;
-(void)setRowAlignmentOptions:(SCD_Struct_UI34)arg1 ;
-(BOOL)leftToRight;
