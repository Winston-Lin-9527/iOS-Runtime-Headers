...
@class UITargetedPreview, UIViewPropertyAnimator, _UIPreviewPlatterPresentationController, _UIContextMenuAnimator, NSArray, _UIPortalView, UIViewFloatAnimatableProperty, NSString;
