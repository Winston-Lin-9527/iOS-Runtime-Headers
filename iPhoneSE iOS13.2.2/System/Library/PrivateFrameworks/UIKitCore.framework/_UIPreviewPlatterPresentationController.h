...
@class UIView, UIVisualEffectView, _UIPreviewPlatterView, _UIContextMenuActionsListView, _UIFulfilledContextMenuConfiguration, NSArray, UITapGestureRecognizer, UIPanGestureRecognizer, UITargetedPreview, _UIPreviewPlatterPanController, _UIPreviewPlatterLayoutArbiter, _UIContextMenuStyle, NSString;
...
@property (nonatomic,retain) _UIPreviewPlatterLayoutArbiter * layoutArbiter;                                   //@synthesize layoutArbiter=_layoutArbiter - In the implementation block
...
-(void)setLayoutArbiter:(_UIPreviewPlatterLayoutArbiter *)arg1 ;
...
-(_UIPreviewPlatterLayoutArbiter *)layoutArbiter;
