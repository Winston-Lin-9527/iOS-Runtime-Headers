...
@interface _UISwipeHandler : NSObject <UIGestureRecognizerDelegate, _UISwipeDismissalGestureRecognizerDelegate> {
	...
	SCD_Struct_UI110 _currentSwipeConfig;
...
@property (nonatomic,readonly) SCD_Struct_UI110 currentSwipeConfig; 
...
-(SCD_Struct_UI110)currentSwipeConfig;
-(void)resetSwipe;
-(BOOL)isInteracting;
...
-(SCD_Struct_UI109)_currentSwipeInfoWithTargetOffset:(double)arg1 animated:(BOOL)arg2 usingSpringWithStiffness:(double)arg3 ;
