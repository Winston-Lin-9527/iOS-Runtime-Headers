...
@class PLClickPresentationInteractionManager, UIView, NCBannerPresentationTransitionDelegate, NCNotificationLongLookViewController, UIViewController, UITapGestureRecognizer, NSDate, UIScrollView, NCNotificationViewController, NSString;
