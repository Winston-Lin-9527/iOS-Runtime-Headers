...
@property (nonatomic,retain) VUITextLayout * focusedTextLayout;                   //@synthesize focusedTextLayout=_focusedTextLayout - In the implementation block
...
-(VUITextLayout *)focusedTextLayout;
-(void)setFocusedTextLayout:(VUITextLayout *)arg1 ;
