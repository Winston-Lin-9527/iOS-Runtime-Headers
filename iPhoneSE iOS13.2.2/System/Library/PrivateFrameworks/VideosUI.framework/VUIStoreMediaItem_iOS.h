...
@class NSNumber, NSURL, NSDictionary, VUIStoreFPSKeyLoader, VUIStoreDownloadMonitor, NSObject, NSString, NSError;
...
@property (nonatomic,retain) NSString * alternateAssetURLString;                     //@synthesize alternateAssetURLString=_alternateAssetURLString - In the implementation block
...
-(void)setAlternateAssetURLString:(NSString *)arg1 ;
...
-(NSString *)alternateAssetURLString;
@end
