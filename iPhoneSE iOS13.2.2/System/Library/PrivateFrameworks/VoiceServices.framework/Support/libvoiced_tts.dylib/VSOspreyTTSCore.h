...
@class VSSpeechRequest, VSInstrumentMetrics, NSError, VSAudioData, VSVoiceAsset, VSVoiceResourceAsset, VSServerTTSClient, VSServerTTSConfig, VSSpeechInternalSettings, VSTimeoutCondition;
