...
@property (nonatomic,retain) VSInstrumentMetrics * deviceTTSInstrumentMetrics;              //@synthesize deviceTTSInstrumentMetrics=_deviceTTSInstrumentMetrics - In the implementation block
...
-(VSInstrumentMetrics *)deviceTTSInstrumentMetrics;
-(VSDeviceTTSCore *)deviceTTSCore;
-(void)setDeviceTTSCore:(VSDeviceTTSCore *)arg1 ;
-(void)setDeviceTTSInstrumentMetrics:(VSInstrumentMetrics *)arg1 ;
