...
@interface WebAVSampleBufferErrorListener : NSObject {
	...
	Vector<WTF::RetainPtr<AVSampleBufferDisplayLayer>, 0, WTF::CrashOnOverflow, 16>* _layers;
	Vector<WTF::RetainPtr<AVSampleBufferAudioRenderer>, 0, WTF::CrashOnOverflow, 16>* _renderers;
