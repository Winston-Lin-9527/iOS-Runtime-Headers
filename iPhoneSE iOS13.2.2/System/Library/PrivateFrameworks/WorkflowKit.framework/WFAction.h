...
@class NSArray, WFResourceManager, NSProgress, NSString, NSDictionary, WFContentCollection, NSHashTable, NSMutableDictionary, WFWorkflow, NSAttributedString, WFImage, NSSet, NSDate, ICApp, WFActionParameterSummary, WFParameter;
