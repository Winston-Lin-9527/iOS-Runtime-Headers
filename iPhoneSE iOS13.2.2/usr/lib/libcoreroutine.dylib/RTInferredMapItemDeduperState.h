...
-(BOOL)ingestInferredMapItemWithIntermediateUUID:(RTPair*)arg1 error:(id*)arg2 ;
-(id)inferredMapItemFromInferredMapItemWithIntermediateUUID:(RTPair*)arg1 error:(id*)arg2 ;
-(BOOL)canIngest;
