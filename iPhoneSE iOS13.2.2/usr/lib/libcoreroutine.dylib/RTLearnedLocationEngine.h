...
-(id)extractCandidate:(RTPair*)arg1 fromNearbyCandidates:(id)arg2 extractedCandidate:(RTPair*)arg3 error:(id*)arg4 ;
-(id)createRelabeler;
-(id)createRelabelerPersisterWithError:(id*)arg1 ;
-(BOOL)_relabelWithRelabeler:(id)arg1 relabelerPersister:(id)arg2 error:(id*)arg3 ;
-(id)getRelabeledInferredMapItemForCandidate:(RTPair*)arg1 relabeler:(id)arg2 loiIdentifierToCoalescedSourceMap:(id)arg3 submitMetrics:(BOOL)arg4 error:(id*)arg5 ;
