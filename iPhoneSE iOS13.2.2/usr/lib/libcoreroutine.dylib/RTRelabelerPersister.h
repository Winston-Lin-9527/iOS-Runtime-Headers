...
@class RTRelabelerPersisterMetrics, NSManagedObjectContext, RTDistanceCalculator, RTMapItemProviderReverseGeocode, RTMapItemProviderLearnedPlaceParameters, NSMutableDictionary, RTRelabelerParameters, RTRelabelerPersisterParameters;
...
-(BOOL)useRelabeledInferredMapItem:(id)arg1 oldCandidate:(RTPair*)arg2 associate:(BOOL)arg3 error:(id*)arg4 ;
-(BOOL)restoreToOldCandidate:(RTPair*)arg1 error:(id*)arg2 ;
...
-(BOOL)restoreVisit:(id)arg1 transitions:(id)arg2 toOldCandidate:(RTPair*)arg3 error:(id*)arg4 ;
...
-(BOOL)unassociateOldCandidate:(RTPair*)arg1 error:(id*)arg2 ;
-(BOOL)associateNonPlaceholderRelabeledInferredMapItem:(id)arg1 oldCandidate:(RTPair*)arg2 error:(id*)arg3 ;
-(BOOL)associatePlaceholderRelabeledInferredMapItem:(id)arg1 oldCandidate:(RTPair*)arg2 error:(id*)arg3 ;
